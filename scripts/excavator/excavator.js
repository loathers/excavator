...
init_kolmafia_polyfill();
var import_es_string3 = __toESM(require_es_string_match_all(), 1), import_kolmafia15 = require("kolmafia");
function _typeof5(o) {
  "@babel/helpers - typeof";
...
function extractItems(text) {
  return new Map(Object.entries((0, import_kolmafia23.extractItems)(text)).map(function(_ref13) {

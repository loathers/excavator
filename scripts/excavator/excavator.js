...
init_kolmafia_polyfill();
var import_kolmafia6 = require("kolmafia"), COOKBOOKBAT = {
  name: "Cookbookbat",
  description: "Determine the possible locations for Cookbookbat quests",
  author: "Shiverwarp",
  hooks: {
    COMBAT_ROUND: function(meta, page) {
      if ((0, import_kolmafia6.currentRound)() !== 0 || (0, import_kolmafia6.myFamiliar)() !== import_kolmafia6.Familiar.get("Cookbookbat")) return null;
      var currentQuest = (0, import_kolmafia6.getProperty)("_cookbookbatQuestLastLocation");
      if (!currentQuest) return null;
      var previousQuest = import_kolmafia6.sessionStorage.getItem("lastCookbookbatQuestLocation");
      return currentQuest === previousQuest ? null : (import_kolmafia6.sessionStorage.setItem("lastCookbookbatQuestLocation", currentQuest), {
...
function spadeSkeleton(encounter, page) {
  if (Number((0, import_kolmafia7.getProperty)("_knuckleboneDrops")) >= 100 || (0, import_kolmafia7.currentRound)() !== 0 || (0, import_kolmafia7.myFamiliar)() !== import_kolmafia7.Familiar.get("Skeleton of Crimbo Past") || !page.includes("WINWINWIN")) return null;
  var monster = (0, import_kolmafia7.lastMonster)(), monsterName = toNormalisedString(monster);
  return /\[\d+\]darkness/.test(monsterName) ? null : {
    gotDrop: page.includes("You acquire an item: <b>knucklebone</b>"),
    dropsToday: Number((0, import_kolmafia7.getProperty)("_knuckleboneDrops")),
    location: toNormalisedString((0, import_kolmafia7.myLocation)()),
    baseWeight: (0, import_kolmafia7.familiarWeight)(import_kolmafia7.Familiar.get("Skeleton of Crimbo Past")),
    buffedWeight: (0, import_kolmafia7.familiarWeight)(import_kolmafia7.Familiar.get("Skeleton of Crimbo Past")) + (0, import_kolmafia7.weightAdjustment)(),
    hasCane: (0, import_kolmafia7.haveEquipped)(import_kolmafia7.Item.get("small peppermint-flavored sugar walking crook")),
...
function spadeSweatpants(encounter, page) {
  var _page$match;
  if (!isEquippedAtEndOfCombat(import_kolmafia8.Item.get(["designer sweatpants", "replica designer sweatpants"]))) return null;
  ...
  var location = toNormalisedString((0, import_kolmafia8.myLocation)());
...
var DROP_BINDLESTOCKING = {
  ...
  hooks: {
    COMBAT_ROUND: function(_, page) {
      if ((0, import_kolmafia9.equippedAmount)(import_kolmafia9.Item.get("bindlestocking")) < 1) return null;
...
init_kolmafia_polyfill();
var import_es_string = __toESM(require_es_string_match_all(), 1), import_kolmafia10 = require("kolmafia");
var PATTERNS = [/and find a weird thing you don't remember packing in the first place.*?You acquire an item: <b>(.*?)<\/b>/, /go into your kitchen and try to recreate it.*?You acquire an item: <b>(.*?)<\/b>/, /that dinner is still in your refrigerator.*?You acquire an item: <b>(.*?)<\/b>/], DROP_CON_SNOWGLOBE = {
  ...
  hooks: {
    COMBAT_ROUND: function(_, page) {
      if (!isEquippedAtEndOfCombat(import_kolmafia10.Item.get("KoL Con 13 snowglobe"))) return null;
...
var DROP_MIXED_EVERYTHING = {
  ...
  hooks: {
    COMBAT_ROUND: function(encounter, page) {
      if (!isEquippedAtEndOfCombat(import_kolmafia11.Item.get("can of mixed everything"))) return null;
...
var DROP_MR_CHEENGS = {
  ...
  hooks: {
    COMBAT_ROUND: function(encounter, page) {
      if (!isEquippedAtEndOfCombat(import_kolmafia12.Item.get("Mr. Cheeng's spectacles"))) return null;
...
var DROP_MR_SCREEGES = {
  ...
  hooks: {
    COMBAT_ROUND: function(encounter, page) {
      if (!isEquippedAtEndOfCombat(import_kolmafia13.Item.get("Mr. Screege's spectacles"))) return null;
...
var DROP_ORDNANCE_MAGNET = {
  ...
  hooks: {
    COMBAT_ROUND: function(encounter, page) {
      if (!isEquippedAtEndOfCombat(import_kolmafia14.Item.get("ordnance magnet"))) return null;
...
var DROP_PORTABLE_LAUGHING_STOCK = {
  ...
  hooks: {
    COMBAT_ROUND: function(encounter, page) {
      if (!isEquippedAtEndOfCombat(import_kolmafia15.Item.get("portable laughing stock"))) return null;
      ...
      return {
        ...
        item: item,
        dropsToday: Number((0, import_kolmafia15.getProperty)("_laughingStockFruitDropped")),
        turns: (0, import_kolmafia15.myTurncount)(),
        class: (0, import_kolmafia15.myClass)().id,
        daycount: (0, import_kolmafia15.myDaycount)()
      };
    }
  }
};
...
var DROP_PULLED_RED_TAFFY = {
  ...
  hooks: {
    COMBAT_ROUND: function(encounter, page) {
      if ((0, import_kolmafia16.currentRound)() !== 0 || (0, import_kolmafia16.myLocation)() === import_kolmafia16.Location.none) return null;
      if ((0, import_kolmafia16.myLocation)().environment === "underwater" || (0, import_kolmafia16.getProperty)("_seadentWaveZone") === "".concat((0, import_kolmafia16.myLocation)())) {
...
init_kolmafia_polyfill();
var import_kolmafia17 = require("kolmafia"), GENIE = {
  name: "Genie",
...
function spadeGenie(page) {
  ...
  if (fightWished) {
    var monster = (0, import_kolmafia17.toMonster)(fightWished[1]);
    if (monster === import_kolmafia17.Monster.none) return null;
    ...
    var effect = (0, import_kolmafia17.toEffect)(effectWished[1]);
    if (effect === import_kolmafia17.Effect.none) return null;
...
init_kolmafia_polyfill();
var import_kolmafia18 = require("kolmafia"), HOOKAH = {
  name: "Hookah",
...
function extractEffectFromEvent(page, eventTriggerText) {
  var _page$match;
  if (!page.includes(eventTriggerText)) return import_kolmafia18.Effect.none;
  ...
  return descid ? (0, import_kolmafia18.descToEffect)(descid) : import_kolmafia18.Effect.none;
}
...
function checkHookahSource(page, source, eventTriggerText) {
  ...
  return effect === import_kolmafia18.Effect.none || isHookahable(effect) ? null : {
    source: source,
    effect: effect.toString()
  };
}
function spadeHookah(encounter, page) {
  switch ((0, import_kolmafia18.currentRound)()) {
    // End of battle
    case 0:
      return (0, import_kolmafia18.equippedAmount)(import_kolmafia18.Item.get("enhanced signal receiver")) > 0 ? checkHookahSource(page, "enhanced signal receiver", "Your signal receiver pipes up:") : (0, import_kolmafia18.getProperty)("_horsery") === "crazy horse" && (0, import_kolmafia18.getProperty)("_horseryCrazyName") ? checkHookahSource(page, "crazy horse", (0, import_kolmafia18.getProperty)("_horseryCrazyName")) : null;
    // Start of battle
    case 1:
      return (0, import_kolmafia18.equippedAmount)(import_kolmafia18.Item.get("ittah bittah hookah")) > 0 ? checkHookahSource(page, "ittah bittha hookah", "takes a pull on the hookah") : null;
    default:
      return null;
  }
}
...
function spadeKiwi(encounter, page) {
  return (0, import_kolmafia19.currentRound)() !== 0 || (0, import_kolmafia19.myFamiliar)() !== import_kolmafia19.Familiar.get("Mini Kiwi") ? null : {
    player: Number((0, import_kolmafia19.myId)()),
    gotDrop: page.includes("You acquire an item: <b>mini kiwi</b>"),
    dropsToday: Number((0, import_kolmafia19.getProperty)("_miniKiwiDrops")),
    location: toNormalisedString((0, import_kolmafia19.myLocation)()),
    path: toNormalisedString((0, import_kolmafia19.myPath)()),
    baseWeight: (0, import_kolmafia19.familiarWeight)(import_kolmafia19.Familiar.get("Mini Kiwi")),
    buffedWeight: (0, import_kolmafia19.familiarWeight)(import_kolmafia19.Familiar.get("Mini Kiwi")) + (0, import_kolmafia19.weightAdjustment)(),
    turn: (0, import_kolmafia19.myTotalTurnsSpent)(),
    hasGoggles: (0, import_kolmafia19.haveEquipped)(import_kolmafia19.Item.get("aviator goggles")),
    monster: toNormalisedString((0, import_kolmafia19.lastMonster)())
  };
}
var MINI_KIWI = {
  name: "Mini Kiwi",
...
init_kolmafia_polyfill();
var import_es_string3 = __toESM(require_es_string_match_all(), 1), import_kolmafia20 = require("kolmafia");
function _typeof5(o) {
  "@babel/helpers - typeof";
...
}, MONSTER_DENYLIST = import_kolmafia20.Monster.get(["the darkness (blind)"]), MONSTER_SEARCH_DENYLIST = import_kolmafia20.Monster.get(["Perceiver of Sensations", "Performer of Actions", "Thinker of Thoughts"]), INDICATORS = [
  // { type: "familiar", prerequisite: Familiar.get("Bowlet"), pattern: "flaps directly into your opponent's (.+?), causing \\d+? damage" },
  {
    type: "effect",
    prerequisite: import_kolmafia20.Effect.get("Little Mouse Skull Buddy"),
    pattern: "The cute little floating mouse skull nibbles at your opponent's (.+?), dealing \\d+? damage"
  },
  {
    type: "equip",
    prerequisite: import_kolmafia20.Item.get("battery-powered drill"),
    pattern: "You drill a neat hole in your opponent's (.+?) which deals \\d+? damage"
  },
  {
    type: "equip",
    prerequisite: import_kolmafia20.Item.get("high-temperature mining drill"),
    pattern: "You drill a neat hole in your opponent's (.+?) which deals \\d+? damage"
  },
  {
    type: "familiar",
    prerequisite: import_kolmafia20.Familiar.get("Adorable Seal Larva"),
    pattern: "fangs your opponent in the (.+?) and greedily sucks the vital juices from the wound"
  },
  {
    type: "familiar",
    prerequisite: import_kolmafia20.Familiar.get("Adventurous Spelunker"),
    pattern: "whips your opponent in the (.+?), dealing \\d+? damage"
  },
  {
    type: "familiar",
    prerequisite: import_kolmafia20.Familiar.get("Left-Hand Man"),
    pattern: "smacks your opponent in the (.+?) with the"
  },
  {
    type: "item",
    prerequisite: import_kolmafia20.Item.get("electronics kit"),
    pattern: "You wire up a quick circuit and hook it to your opponent's (.+?)\\. You flip the switch"
  },
  {
    type: "item",
    prerequisite: import_kolmafia20.Item.get("small golem"),
...
function checkPrerequisite(_ref) {
  ...
  switch (type) {
    case "skill":
      return (0, import_kolmafia20.haveSkill)(prerequisite);
    case "effect":
      return (0, import_kolmafia20.haveEffect)(prerequisite) > 0;
    case "familiar":
      return (0, import_kolmafia20.myFamiliar)() === prerequisite;
    case "equip":
      return (0, import_kolmafia20.haveEquipped)(prerequisite);
    case "plant":
      return (_getFloristPlants$myL = (_getFloristPlants$myL2 = (0, import_kolmafia20.getFloristPlants)()[(0, import_kolmafia20.myLocation)().toString()]) === null || _getFloristPlants$myL2 === void 0 ? void 0 : _getFloristPlants$myL2.includes(prerequisite)) !== null && _getFloristPlants$myL !== void 0 ? _getFloristPlants$myL : !1;
    default:
      return !1;
  }
}
...
function checkElVibratoRestraints(data, page, monster, monsterParts) {
  if (!((0, import_kolmafia20.availableAmount)(import_kolmafia20.Item.get("El Vibrato restraints")) === 0 || !page.includes("lvcuff.gif"))) {
    var base = {
      monster: monster,
      part: "arm",
...
var MUTANT_COUTURE_SKILLS = {
  head: import_kolmafia20.Skill.get("Strangle"),
  arm: import_kolmafia20.Skill.get("Disarm"),
  leg: import_kolmafia20.Skill.get("Entangle")
};
function checkMutantCouture(data, page, monster, monsterParts) {
  (0, import_kolmafia20.currentRound)() !== 1 || !(0, import_kolmafia20.isWearingOutfit)("Mutant Couture") || !page.includes("<select name=whichskill>") || (data.push.apply(data, _toConsumableArray3(Object.entries(MUTANT_COUTURE_SKILLS).filter(function(_ref2) {
...
function checkEverfullDartHolster(data, page, monster, monsterParts) {
  if (!((0, import_kolmafia20.currentRound)() !== 1 || // eslint-disable-next-line libram/verify-constants
  !(0, import_kolmafia20.haveEquipped)(import_kolmafia20.Item.get("Everfull Dart Holster")))) {
    var buttAwareness = (0, import_kolmafia20.getProperty)("everfullDartPerks").includes("Butt awareness"), allDartParts = _toConsumableArray3(page.matchAll(DART_REGEX)).map(function(match) {
      return match[1];
...
function spadeMonsterParts(encounter, page) {
  if (MONSTER_DENYLIST.includes((0, import_kolmafia20.lastMonster)())) return null;
  var path = (0, import_kolmafia20.myPath)();
  if (path == import_kolmafia20.Path.get("Fall of the Dinosaurs") || path == import_kolmafia20.Path.get("Pocket Familiars")) return null;
  var monster = toNormalisedString((0, import_kolmafia20.lastMonster)()), monsterParts = (0, import_kolmafia20.lastMonster)().parts, data = [];
  return !isAdventureTextAltered() && !MONSTER_SEARCH_DENYLIST.includes((0, import_kolmafia20.lastMonster)()) && (checkSimpleIndicators(data, page, monster, monsterParts), checkElVibratoRestraints(data, page, monster, monsterParts)), checkMutantCouture(data, page, monster, monsterParts), checkEverfullDartHolster(data, page, monster, monsterParts), data;
}
...
function spadeMummingTrunk(encounter, page) {
  if ((0, import_kolmafia21.availableAmount)(import_kolmafia21.Item.get("mumming trunk")) === 0) return null;
  var fam = (0, import_kolmafia21.myFamiliar)();
  return (0, import_kolmafia21.getProperty)("_mummeryMods").includes(fam.toString()) ? (0, import_kolmafia21.getProperty)("_mummeryUses").split(",").filter(function(costume) {
...
var OUT_OF_ORDER = {
  ...
  hooks: {
    COMBAT_ROUND: function(encounter, page) {
      if ((0, import_kolmafia22.getProperty)("questEspOutOfOrder") === "unstarted" || !isEquippedAtEndOfCombat(import_kolmafia22.Item.get("GPS-tracking wristwatch")) || (0, import_kolmafia22.myLocation)() !== import_kolmafia22.Location.get("The Deep Dark Jungle")) return null;
      var beeps = page.match(/Your GPS tracker beeps ([0-9]+) times as it zeroes in on your quarry/);
      return beeps ? {
        beeps: beeps[1],
        initiative: (0, import_kolmafia22.numericModifier)(import_kolmafia22.Modifier.get("Initiative"))
      } : null;
    }
  }
};
...
function spadeSkeletonLetters(encounter, page) {
  if ((0, import_kolmafia23.currentRound)() !== 0 || !import_kolmafia23.Monster.get(["Axis artillery skeleton", "Axis grenadier skeleton", "Axis infantry skeleton", "Axis officer skeleton"]).includes((0, import_kolmafia23.lastMonster)())) return null;
  var regimentMatch = page.match(RegExp("".concat((0, import_kolmafia23.lastMonster)(), ", (\\d+)[a-z]+ regiment</span>")));
  if (regimentMatch) {
    var ribMatch = page.matchAll(/\/otherimages\/skeletonwar\/rib(\d)\.png/g), ribs = _toConsumableArray4(ribMatch).map(function(matchArray) {
      return matchArray[1];
    }).sort().join(","), regiment = Number(regimentMatch[1]), monster = (0, import_kolmafia23.lastMonster)().name;
    return {
      ribs: ribs,
      regiment: regiment,
      monster: monster
...
var SUBTYPE_GHOST = {
  ...
  hooks: {
    COMBAT_ROUND: function(encounter, page) {
      var path = (0, import_kolmafia24.myPath)();
      if (path == import_kolmafia24.Path.get("Pocket Familiars") || path == import_kolmafia24.Path.get("WereProfessor") || (0, import_kolmafia24.currentRound)() !== 1 || !page.includes("<select name=whichskill>"))
        return null;
      var monster = (0, import_kolmafia24.lastMonster)(), expected = monster.attributes.includes("GHOST");
...
function pinchGhost(monster, expected) {
  if (!(0, import_kolmafia24.haveSkill)(import_kolmafia24.Skill.get("Pinch Ghost")))
    return null;
  var actual = (0, import_kolmafia24.combatSkillAvailable)(import_kolmafia24.Skill.get("Pinch Ghost"));
...
function protonicAccelerator(monster, expected) {
  if (!(0, import_kolmafia24.haveEquipped)(import_kolmafia24.Item.get("protonic accelerator pack")))
    return null;
  var actual = (0, import_kolmafia24.combatSkillAvailable)(import_kolmafia24.Skill.get("Shoot Ghost")) || (0, import_kolmafia24.combatSkillAvailable)(import_kolmafia24.Skill.get("Trap Ghost"));
  return actual !== expected ? {
    monster: toNormalisedString(monster),
    ghost: actual,
    reason: "ProtoPack"
...
var SUBTYPE_SKELETON = {
  ...
  hooks: {
    COMBAT_ROUND: function(encounter, page) {
      ...
      if (path == import_kolmafia25.Path.get("Pocket Familiars") || path == import_kolmafia25.Path.get("WereProfessor") || (0, import_kolmafia25.currentRound)() !== 1 || !page.includes("<select name=whichskill>") || !(0, import_kolmafia25.haveEquipped)(import_kolmafia25.Item.get("ring of telling skeletons what to do")))
        return null;
      var monster = (0, import_kolmafia25.lastMonster)(), expected = monster.attributes.includes("SKELETON"), actual = void 0;
      if ((0, import_kolmafia25.combatSkillAvailable)(import_kolmafia25.Skill.get("Tell This Skeleton What To Do")))
        actual = !0;
      else if ((0, import_kolmafia25.combatSkillAvailable)(import_kolmafia25.Skill.get("Tell a Skeleton What To Do")))
        actual = !1;
      else
        return null;
      return actual !== expected ? {
...
var SUBTYPE_ZOMBIE = {
  ...
  hooks: {
    COMBAT_ROUND: function(encounter, page) {
      if ((0, import_kolmafia26.currentRound)() !== 0)
        return null;
      if (page.includes("You grab a plump, wriggling worm from what's left of that zombie.")) {
        var monster = (0, import_kolmafia26.lastMonster)(), expected = monster.attributes.includes("ZOMBIE");
        if (!expected)
          return {
            monster: toNormalisedString(monster),
            zombie: !0
...
var ZONE_PATTERNS = /* @__PURE__ */ new Map([["Conspiracy Island", /The swarm of mayflies buzzes off into the spooky distance and returns a few minutes later, struggling under the weight of a mysterious coin/], ["Dinseylandfill", /The swarm of mayflies buzzes off into the distance and returns a few moments later carrying a rolled up FunFunds/], ["Twitch", /The swarm of mayflies buzzes off into the greasy distance and returns a few minutes later, struggling under the weight of a shiny coin/], ["Spring Break Beach", /The swarm of mayflies buzzes off into the greasy distance and returns a few minutes later, struggling under the weight of a damp bill/], ["The Glaciest", /The swarm of mayflies buzzes off into the frigid distance and returns a short while later carrying a rolled up Wal-Mart gift certificate/], ["Dreadsylvania", /The swarm of mayflies buzzes off into the dreary distance and returns a few minutes later, struggling under the weight of a coin/], ["Degrassi Knoll", /The swarm of mayflies buzzes off in the direction of one of the myriad workbenches littering the Knoll/]]), LOCATION_PATTERNS = /* @__PURE__ */ new Map([[import_kolmafia27.Location.get("Hobopolis Town Square"), /The swarm of mayflies buzzes off into the distance and returns a few minutes later, struggling under the weight of a coin/], [import_kolmafia27.Location.get("The Hole in the Sky"), /mistakes the swarm of flies for a different (and apparently very frightening) constellation, and runs off so fast it leaves some little bits of itself behind/], [import_kolmafia27.Location.get("The Sleazy Back Alley"), /The swarm flies into a dumpster, buzzes around for a bit, and flies back out looking slightly larger/], [import_kolmafia27.Location.get("The Slime Tube"), /The swarm of mayflies plunges into the mass of Slime and emerges a few moments later, coated with goo and carrying a little glob of something/], [import_kolmafia27.Location.get("South of The Border"), /After the fight is over, one of those annoying kids runs up and tries to sell you some gum/]]), SWARM_PATTERN = /mayflies(\d+)\.gif/, ITEM_PATTERN = /The swarm of mayflies buzzes around the ground, helping you find stuff/, MEAT_PATTERN = /The swarm of mayflies draws your attention to more Meat than you would've otherwise found/, SUMMON_MAYFLY_SWARM = {
  ...
  hooks: {
    COMBAT_ROUND: function(_, page) {
      ...
      if (!isEquippedAtEndOfCombat(import_kolmafia27.Item.get("mayfly bait necklace"))) return null;
      var specialPattern = (_ZONE_PATTERNS$get = ZONE_PATTERNS.get((0, import_kolmafia27.myLocation)().zone)) !== null && _ZONE_PATTERNS$get !== void 0 ? _ZONE_PATTERNS$get : LOCATION_PATTERNS.get((0, import_kolmafia27.myLocation)());
      if (!specialPattern) return null;
      var swarmResult = page.match(SWARM_PATTERN);
      if (!swarmResult) return null;
      var swarmSize = Number(swarmResult[1]), area = ZONE_PATTERNS.has((0, import_kolmafia27.myLocation)().zone) ? (0, import_kolmafia27.myLocation)().zone : "".concat((0, import_kolmafia27.myLocation)()), patterns = {
...
function spadeRiftlet(encounter, page) {
  var riftlet = import_kolmafia28.Familiar.get("Temporal Riftlet");
  return (0, import_kolmafia28.currentRound)() !== 0 || (0, import_kolmafia28.myFamiliar)() !== riftlet ? null : {
    weight: (0, import_kolmafia28.familiarWeight)(riftlet) + (0, import_kolmafia28.weightAdjustment)() + riftlet.soupWeight + (riftlet.feasted ? 10 : 0),
...
var createPropertyGetter = function(transform) {
  return function(property, default_) {
    var value = (0, import_kolmafia30.getProperty)(property);
...
var getString = createPropertyGetter(function(value) {
  ...
  return Number(value);
}), getBounty = createMafiaClassPropertyGetter(import_kolmafia30.Bounty, import_kolmafia30.toBounty), getClass = createMafiaClassPropertyGetter(import_kolmafia30.Class, import_kolmafia30.toClass), getCoinmaster = createMafiaClassPropertyGetter(import_kolmafia30.Coinmaster, import_kolmafia30.toCoinmaster), getEffect = createMafiaClassPropertyGetter(import_kolmafia30.Effect, import_kolmafia30.toEffect), getElement = createMafiaClassPropertyGetter(import_kolmafia30.Element, import_kolmafia30.toElement), getFamiliar = createMafiaClassPropertyGetter(import_kolmafia30.Familiar, import_kolmafia30.toFamiliar, familiarNumericProperties), getItem = createMafiaClassPropertyGetter(import_kolmafia30.Item, import_kolmafia30.toItem, itemNumericProperties), getLocation = createMafiaClassPropertyGetter(import_kolmafia30.Location, import_kolmafia30.toLocation), getMonster = createMafiaClassPropertyGetter(import_kolmafia30.Monster, import_kolmafia30.toMonster, monsterNumericProperties), getPhylum = createMafiaClassPropertyGetter(import_kolmafia30.Phylum, import_kolmafia30.toPhylum), getServant = createMafiaClassPropertyGetter(import_kolmafia30.Servant, import_kolmafia30.toServant), getSkill = createMafiaClassPropertyGetter(import_kolmafia30.Skill, import_kolmafia30.toSkill), getSlot = createMafiaClassPropertyGetter(import_kolmafia30.Slot, import_kolmafia30.toSlot), getStat = createMafiaClassPropertyGetter(import_kolmafia30.Stat, import_kolmafia30.toStat), getThrall = createMafiaClassPropertyGetter(import_kolmafia30.Thrall, import_kolmafia30.toThrall);
function get(property, _default) {
  ...
  return _default instanceof import_kolmafia30.Location ? getLocation(property, _default) : _default instanceof import_kolmafia30.Monster ? getMonster(property, _default) : _default instanceof import_kolmafia30.Familiar ? getFamiliar(property, _default) : _default instanceof import_kolmafia30.Stat ? getStat(property, _default) : _default instanceof import_kolmafia30.Phylum ? getPhylum(property, _default) : _default instanceof import_kolmafia30.Item ? getItem(property, _default) : typeof _default == "boolean" ? value === "true" ? !0 : value === "false" ? !1 : _default : typeof _default == "number" ? value === "" ? _default : parseInt(value) : value === "" ? _default === void 0 ? "" : _default : value;
}
function _set(property, value) {
  var stringValue = value === null ? "" : value.toString();
  return (0, import_kolmafia30.setProperty)(property, stringValue), value;
}
  ...
  return _createClass(PropertiesManager2, [{
    ...
    value: function(propertiesToSet) {
      for (var _i2 = 0, _Object$entries2 = Object.entries(propertiesToSet); _i2 < _Object$entries2.length; _i2++) {
        ...
        propertyName in this.properties || (this.properties[propertyName] = (0, import_kolmafia30.propertyExists)(propertyName) ? get(propertyName) : PropertiesManager2.EMPTY_PREFERENCE), _set(propertyName, propertyValue);
      }
    }
    /**
    ...
    value: function() {
      ...
      for (var _i3 = 0, _properties = properties; _i3 < _properties.length; _i3++) {
        ...
        if (property in this.properties) {
          ...
          value === PropertiesManager2.EMPTY_PREFERENCE ? (0, import_kolmafia30.removeProperty)(property) : _set(property, value);
        }
      }
    }
    /**
...
var concatTemplateString = function(literals) {
  ...
  match ? (0, import_kolmafia31.print)("".concat(match[0], "; if you're certain that this ").concat(Type.name, " exists and is spelled correctly, please update KoLMafia"), "red") : (0, import_kolmafia31.print)(message);
...
}, $bounty = createSingleConstant(import_kolmafia31.Bounty, import_kolmafia31.toBounty), $bounties = createPluralConstant(import_kolmafia31.Bounty), $class = createSingleConstant(import_kolmafia31.Class, import_kolmafia31.toClass), $classes = createPluralConstant(import_kolmafia31.Class), $coinmaster = createSingleConstant(import_kolmafia31.Coinmaster, import_kolmafia31.toCoinmaster), $coinmasters = createPluralConstant(import_kolmafia31.Coinmaster), $effect = createSingleConstant(import_kolmafia31.Effect, import_kolmafia31.toEffect), $effects = createPluralConstant(import_kolmafia31.Effect), $element = createSingleConstant(import_kolmafia31.Element, import_kolmafia31.toElement), $elements = createPluralConstant(import_kolmafia31.Element), $familiar = createSingleConstant(import_kolmafia31.Familiar, import_kolmafia31.toFamiliar), $familiars = createPluralConstant(import_kolmafia31.Familiar), $item = createSingleConstant(import_kolmafia31.Item, import_kolmafia31.toItem), $items = createPluralConstant(import_kolmafia31.Item), $location = createSingleConstant(import_kolmafia31.Location, import_kolmafia31.toLocation), $locations = createPluralConstant(import_kolmafia31.Location), $modifier = createSingleConstant(import_kolmafia31.Modifier, import_kolmafia31.toModifier), $modifiers = createPluralConstant(import_kolmafia31.Modifier), $monster = createSingleConstant(import_kolmafia31.Monster, import_kolmafia31.toMonster), $monsters = createPluralConstant(import_kolmafia31.Monster), $path = createSingleConstant(import_kolmafia31.Path, import_kolmafia31.toPath), $paths = createPluralConstant(import_kolmafia31.Path), $phylum = createSingleConstant(import_kolmafia31.Phylum, import_kolmafia31.toPhylum), $phyla = createPluralConstant(import_kolmafia31.Phylum), $servant = createSingleConstant(import_kolmafia31.Servant, import_kolmafia31.toServant), $servants = createPluralConstant(import_kolmafia31.Servant), $skill = createSingleConstant(import_kolmafia31.Skill, import_kolmafia31.toSkill), $skills = createPluralConstant(import_kolmafia31.Skill), $slot = createSingleConstant(import_kolmafia31.Slot, import_kolmafia31.toSlot), $slots = createPluralConstant(import_kolmafia31.Slot), $stat = createSingleConstant(import_kolmafia31.Stat, import_kolmafia31.toStat), $stats = createPluralConstant(import_kolmafia31.Stat), $thrall = createSingleConstant(import_kolmafia31.Thrall, import_kolmafia31.toThrall), $thralls = createPluralConstant(import_kolmafia31.Thrall);
...
var byStat = makeByXFunction(function() {
  return (0, import_kolmafia32.myPrimestat)().toString();
}), byClass = makeByXFunction(function() {
  return (0, import_kolmafia32.myClass)().toString();
});
function extractItems(text) {
  return new Map(Object.entries((0, import_kolmafia32.extractItems)(text)).map(function(_ref13) {
    var _ref14 = _slicedToArray8(_ref13, 2), itemName = _ref14[0], quantity = _ref14[1];
    return [import_kolmafia32.Item.get(itemName), quantity];
  }));
}
function makeScalerCalcFunction(cache, pattern) {
  return function(monster) {
    var _find, _pattern$exec$slice, _pattern$exec, current = cache.get(monster);
    if (current !== void 0) return (0, import_kolmafia32.monsterEval)(current);
    ...
    return cache.set(monster, result), (0, import_kolmafia32.monsterEval)(result);
  };
}
...
var makeBulkFunction = function(action) {
  return function(items) {
    ...
    return (0, import_kolmafia32.batchClose)();
  };
}, bulkAutosell = makeBulkFunction(import_kolmafia32.autosell), bulkPutCloset = makeBulkFunction(import_kolmafia32.putCloset), bulkPutDisplay = makeBulkFunction(import_kolmafia32.putDisplay), bulkPutStash = makeBulkFunction(import_kolmafia32.putStash), bulkTakeCloset = makeBulkFunction(import_kolmafia32.takeCloset), bulkTakeDisplay = makeBulkFunction(import_kolmafia32.takeDisplay), bulkTakeShop = makeBulkFunction(import_kolmafia32.takeShop), bulkTakeStash = makeBulkFunction(import_kolmafia32.takeStash), bulkTakeStorage = makeBulkFunction(import_kolmafia32.takeStorage);
...
init_kolmafia_polyfill();
var import_html_entities = __toESM(require_lib(), 1), import_kolmafia34 = require("kolmafia");
...
function fetchUrl(path) {
  ...
  return (0, import_kolmafia33.visitUrl)(url, method === "POST", !0);
}
...
var Kmail = /* @__PURE__ */ function() {
  ...
  return _createClass2(Kmail2, [{
    ...
    value: function() {
      ...
      return !outsideAttachments && !insideAttachments ? 0 : (0, import_kolmafia34.extractMeat)("".concat(outsideAttachments).concat(insideAttachments));
    }
    /**
     * Reply to kmail
     *
    ...
    value: function() {
      ...
      return JSON.parse((0, import_kolmafia34.visitUrl)("api.php?what=kmail&for=libram&count=".concat(count))).map(Kmail2.parse);
    }
    /**
     * Bulk delete kmails
     *
    ...
    value: function(to, message, items, meat, chunkSize, constructUrl, successString) {
      var m = meat, sendableItems = _toConsumableArray7(arrayToCountedMap(items).entries()).filter(function(_ref3) {
        ...
        return (0, import_kolmafia34.isGiftable)(item);
...
function getExcavatorVersion() {
  return (0, import_kolmafia35.gitInfo)("loathers-excavator-release").commit.substring(0, 7) || (0, import_kolmafia35.gitInfo)("gausie-excavator-release").commit.substring(0, 7) || 0;
}
function getVersionString() {
  return "".concat((0, import_kolmafia35.getRevision)(), "/").concat(getExcavatorVersion());
}
function canKmail() {
  return (
    // In a fight
    !((0, import_kolmafia35.currentRound)() > 0 || // In a choice
    (0, import_kolmafia35.handlingChoice)() || // Was in a choice, gonna be in a fight
    (0, import_kolmafia35.fightFollowsChoice)() || // Was in a fight, gonna be in a choice
    (0, import_kolmafia35.choiceFollowsFight)() || // Was in a fight, gonna be in another fight
    (0, import_kolmafia35.inMultiFight)())
  );
}
...
function flushSpadingData() {
  for (var spadingData = get(DATA_PROPERTY).split("|"), i = 0; i < spadingData.length - 2; ) {
    ...
    if (!success) {
      (0, import_kolmafia35.print)("Sending a kmail failed while Excavator was flushing the spading cache. Flush aborted.", "red");
      return;
    }
    i++;
  }
...
function sendSpadingData(projectName, data) {
  ...
  if (canKmail()) {
    ...
    (0, import_kolmafia35.printHtml)('<font color="green">Sending spading data for <b>'.concat(projectName, "</b>").concat(flushMessage, " to ").concat(recipient, ". Thanks!</font>"));
    var success = Kmail.send(recipient, dataString);
    if (success) {
      flushSpadingData(), deleteSpadingKmail(recipient);
      return;
    }
    (0, import_kolmafia35.print)("Excavator thought it could send data via kmail but it can't. Saving to cache instead.", "orange");
  }
  addSpadingData(dataString, recipient, "Excavator's project to spade ".concat(projectName));
}
function deleteSpadingKmail(sentTo) {
  var buffer = (0, import_kolmafia35.visitUrl)("messages.php?box=Outbox&begin=1&order=0&per_page=10").toLowerCase(), messageIds = buffer.split("td valign=top").filter(function(s) {
  ...
  if (messageIds.length > 0) {
    ...
    (0, import_kolmafia35.visitUrl)(del);
  }
}
...
function main(event, meta, page) {
  projects.filter(function(_ref) {
    ...
    return !completed && event in hooks && since <= (0, import_kolmafia36.getRevision)() && ((0, import_kolmafia36.myPath)() !== import_kolmafia36.Path.get("Two Crazy Random Summer") || allowInTcrs);
  }).map(function(_ref2) {

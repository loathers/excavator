...
var DROP_PULLED_RED_TAFFY = {
  ...
  hooks: {
    COMBAT_ROUND: function(encounter, page) {
      if ((0, import_kolmafia13.currentRound)() !== 0 || (0, import_kolmafia13.myLocation)() === import_kolmafia13.Location.none) return null;
      if ((0, import_kolmafia13.myLocation)().environment === "underwater" || (0, import_kolmafia13.getProperty)("_seadentWaveZone") === "".concat((0, import_kolmafia13.myLocation)())) {

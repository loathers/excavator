...
// ../excavator-projects/projects/blueVsRedMonsters.ts
init_kolmafia_polyfill();
var import_kolmafia5 = require("kolmafia");
var BLUE_TEAM_MONSTERS = {
  ...
  hooks: {
    CHOICE_VISIT: function(choice, page) {
      var color = (0, import_kolmafia5.getProperty)("blueVsRedTeam");
    ...
    CHOICE: function(url, page) {
      var color = (0, import_kolmafia5.getProperty)("blueVsRedTeam");
      if (color !== "blue") return null;
      var match = url.match(/whichchoice=(\d+)/), choiceId = match ? parseInt(match[1], 10) : 0;
      return spadeMonsterTeamAlignedColor(choiceId, page, color);
    }
  }
}, RED_TEAM_MONSTERS = {
...
function spadeMonsterTeamAlignedColor(choice, page, color) {
  if (choice < 1604 || choice > 1636 || (0, import_kolmafia5.myPath)() !== import_kolmafia5.Path.get("Blue vs. Red") || !page.includes("monsterid:")) return null;
  var result = page.match(/<!-- monsterid: (\d+) -->/);
  if (!result) return null;
  var monsterId = parseInt(result[1], 10), monster = import_kolmafia5.Monster.get(monsterId);
  return monster === import_kolmafia5.Monster.none ? null : {
...
var COAT_OF_PAINT = {
  ...
  hooks: {
    DESC_ITEM: function(itemName, page) {
      if (itemName !== import_kolmafia6.Item.get("fresh coat of paint").name) return null;
      var mod = (0, import_kolmafia6.getProperty)("_coatOfPaintModifier");
      return mod === "" || import_kolmafia6.sessionStorage.getItem("reportedCoatOfPaintMod") === mod ? null : (import_kolmafia6.sessionStorage.setItem("reportedCoatOfPaintMod", mod), _objectSpread3(_objectSpread3(_objectSpread3({}, getPaintModifiers(page)), getDaySeed()), getDifficultySeed()));
    }
  }
...
function getPaintModifiers(page) {
  var paintMods = Object.entries(COAT_OF_PAINT_MODIFIERS).reduce(function(data, _ref) {
    var _ref2 = _slicedToArray3(_ref, 2), type = _ref2[0], mods = _ref2[1], mod = mods.find(function(m) {
      return (0, import_kolmafia6.numericModifier)(import_kolmafia6.Item.get("fresh coat of paint"), m) !== 0;
    });
    return _objectSpread3(_objectSpread3({}, data), {}, _defineProperty3(_defineProperty3({}, type, mod || ""), "".concat(type, "_value"), mod ? String((0, import_kolmafia6.numericModifier)(import_kolmafia6.Item.get("fresh coat of paint"), mod)) : ""));
  }, {}), bonus = page.match(COAT_BONUS_REGEX);
  return bonus && (paintMods.bonus = bonus[1]), paintMods;
}

// ../excavator-projects/projects/cookbookbat.ts
init_kolmafia_polyfill();
var import_kolmafia7 = require("kolmafia"), COOKBOOKBAT = {
  name: "Cookbookbat",
  description: "Determine the possible locations for Cookbookbat quests",
  author: "Shiverwarp",
  hooks: {
    COMBAT_ROUND: function(meta, page) {
      if ((0, import_kolmafia7.currentRound)() !== 0 || (0, import_kolmafia7.myFamiliar)() !== import_kolmafia7.Familiar.get("Cookbookbat")) return null;
      var currentQuest = (0, import_kolmafia7.getProperty)("_cookbookbatQuestLastLocation");
      if (!currentQuest) return null;
      var previousQuest = import_kolmafia7.sessionStorage.getItem("lastCookbookbatQuestLocation");
      return currentQuest === previousQuest ? null : (import_kolmafia7.sessionStorage.setItem("lastCookbookbatQuestLocation", currentQuest), {
        questLocation: currentQuest
      });
    }
  }
};

// ../excavator-projects/projects/crimboSkeleton.ts
init_kolmafia_polyfill();
var import_kolmafia8 = require("kolmafia");
var knuckleTexts = ["silently gestures at a loose knucklebone lying on the ground", "wordlessly points out a knucklebone you knocked loose from your opponent", "picks something up off the ground and tosses it to you"];
function extractKnuckleText(page) {
  return knuckleTexts.findIndex(function(t) {
    return page.includes(t);
  });
}
function spadeSkeleton(encounter, page) {
  if (Number((0, import_kolmafia8.getProperty)("_knuckleboneDrops")) >= 100 || (0, import_kolmafia8.currentRound)() !== 0 || (0, import_kolmafia8.myFamiliar)() !== import_kolmafia8.Familiar.get("Skeleton of Crimbo Past") || !page.includes("WINWINWIN")) return null;
  var monster = (0, import_kolmafia8.lastMonster)(), monsterName = toNormalisedString(monster);
  return /\[\d+\]darkness/.test(monsterName) ? null : {
    gotDrop: page.includes("You acquire an item: <b>knucklebone</b>"),
    dropsToday: Number((0, import_kolmafia8.getProperty)("_knuckleboneDrops")),
    location: toNormalisedString((0, import_kolmafia8.myLocation)()),
    baseWeight: (0, import_kolmafia8.familiarWeight)(import_kolmafia8.Familiar.get("Skeleton of Crimbo Past")),
    buffedWeight: (0, import_kolmafia8.familiarWeight)(import_kolmafia8.Familiar.get("Skeleton of Crimbo Past")) + (0, import_kolmafia8.weightAdjustment)(),
    hasCane: (0, import_kolmafia8.haveEquipped)(import_kolmafia8.Item.get("small peppermint-flavored sugar walking crook")),
...
function spadeSweatpants(encounter, page) {
  var _page$match;
  if (!isEquippedAtEndOfCombat(import_kolmafia9.Item.get(["designer sweatpants", "replica designer sweatpants"]))) return null;
  ...
  var location = toNormalisedString((0, import_kolmafia9.myLocation)());
...
var DROP_BINDLESTOCKING = {
  ...
  hooks: {
    COMBAT_ROUND: function(_, page) {
      if ((0, import_kolmafia10.equippedAmount)(import_kolmafia10.Item.get("bindlestocking")) < 1) return null;
...
init_kolmafia_polyfill();
var import_es_string = __toESM(require_es_string_match_all(), 1), import_kolmafia11 = require("kolmafia");
var PATTERNS = [/and find a weird thing you don't remember packing in the first place.*?You acquire an item: <b>(.*?)<\/b>/, /go into your kitchen and try to recreate it.*?You acquire an item: <b>(.*?)<\/b>/, /that dinner is still in your refrigerator.*?You acquire an item: <b>(.*?)<\/b>/], DROP_CON_SNOWGLOBE = {
  ...
  hooks: {
    COMBAT_ROUND: function(_, page) {
      if (!isEquippedAtEndOfCombat(import_kolmafia11.Item.get("KoL Con 13 snowglobe"))) return null;
...
// ../excavator-projects/projects/dropCupOf13s.ts
init_kolmafia_polyfill();
...
var DROP_CUP_OF_13 = {
  ...
  hooks: {
    COMBAT_ROUND: function(encounter, page) {
      if (!isEquippedAtEndOfCombat(import_kolmafia12.Item.get("Cup of 13s"))) return null;
      var result = page.match(/You hear a gurgling from your Cup of 13s.*?You acquire an item: <b>(.*?)<\/b>/);
      if (!result) return null;
      var item = toNormalisedItem(result[1]);
      return {
        item: item,
        dropsToday: Number((0, import_kolmafia12.getProperty)("_cupOf13sDrops"))
      };
    }
  }
};
...
var DROP_MIXED_EVERYTHING = {
  ...
  hooks: {
    COMBAT_ROUND: function(encounter, page) {
      if (!isEquippedAtEndOfCombat(import_kolmafia13.Item.get("can of mixed everything"))) return null;
...
var DROP_MR_CHEENGS = {
  ...
  hooks: {
    COMBAT_ROUND: function(encounter, page) {
      if (!isEquippedAtEndOfCombat(import_kolmafia14.Item.get("Mr. Cheeng's spectacles"))) return null;
...
var DROP_MR_SCREEGES = {
  ...
  hooks: {
    COMBAT_ROUND: function(encounter, page) {
      if (!isEquippedAtEndOfCombat(import_kolmafia15.Item.get("Mr. Screege's spectacles"))) return null;
...
var DROP_ORDNANCE_MAGNET = {
  ...
  hooks: {
    COMBAT_ROUND: function(encounter, page) {
      if (!isEquippedAtEndOfCombat(import_kolmafia16.Item.get("ordnance magnet"))) return null;
...
// ../excavator-projects/projects/dropPortableLaughingStock.ts
init_kolmafia_polyfill();
var import_kolmafia17 = require("kolmafia");
var DROP_PORTABLE_LAUGHING_STOCK = {
  name: "Portable Laughing Stock",
  description: "Track drops from the portable laughing stock.",
  author: "Ignose",
  hooks: {
    COMBAT_ROUND: function(encounter, page) {
      if (!isEquippedAtEndOfCombat(import_kolmafia17.Item.get("portable laughing stock"))) return null;
      var result = page.match(/(?:You get smacked in the face with a piece of fruit from somewhere|The crowd's derision takes a physical form as a piece of fruit sails toward your head|A jeering onlooker chucks something soft and squishy your way|Someone in the crowd hurls a piece of fruit at you|Someone lobs a piece of fruit at you from the crowd).*?You acquire an item: <b>(.*?)<\/b>/);
      if (!result) return null;
      var item = toNormalisedItem(result[1]);
      return {
        player: Number((0, import_kolmafia17.myId)()),
        path: toNormalisedString((0, import_kolmafia17.myPath)()),
        item: item,
        dropsToday: Number((0, import_kolmafia17.getProperty)("_laughingStockFruitDropped")),
        turns: (0, import_kolmafia17.myTurncount)(),
        class: (0, import_kolmafia17.myClass)().id,
        daycount: (0, import_kolmafia17.myDaycount)()
      };
    }
  }
};
...
var DROP_PULLED_RED_TAFFY = {
  ...
  hooks: {
    COMBAT_ROUND: function(encounter, page) {
      if ((0, import_kolmafia18.currentRound)() !== 0 || (0, import_kolmafia18.myLocation)() === import_kolmafia18.Location.none) return null;
      if ((0, import_kolmafia18.myLocation)().environment === "underwater" || (0, import_kolmafia18.getProperty)("_seadentWaveZone") === "".concat((0, import_kolmafia18.myLocation)())) {
...
init_kolmafia_polyfill();
var import_kolmafia19 = require("kolmafia"), GENIE = {
  name: "Genie",
...
function spadeGenie(page) {
  ...
  if (fightWished) {
    var monster = (0, import_kolmafia19.toMonster)(fightWished[1]);
    if (monster === import_kolmafia19.Monster.none) return null;
    ...
    var effect = (0, import_kolmafia19.toEffect)(effectWished[1]);
    if (effect === import_kolmafia19.Effect.none) return null;
...
init_kolmafia_polyfill();
var import_kolmafia20 = require("kolmafia"), HOOKAH = {
  name: "Hookah",
...
function extractEffectFromEvent(page, eventTriggerText) {
  var _page$match;
  if (!page.includes(eventTriggerText)) return import_kolmafia20.Effect.none;
  ...
  return descid ? (0, import_kolmafia20.descToEffect)(descid) : import_kolmafia20.Effect.none;
}
...
function checkHookahSource(page, source, eventTriggerText) {
  ...
  return effect === import_kolmafia20.Effect.none || isHookahable(effect) ? null : {
    source: source,
    effect: effect.toString()
  };
}
function spadeHookah(encounter, page) {
  switch ((0, import_kolmafia20.currentRound)()) {
    // End of battle
    case 0:
      return (0, import_kolmafia20.equippedAmount)(import_kolmafia20.Item.get("enhanced signal receiver")) > 0 ? checkHookahSource(page, "enhanced signal receiver", "Your signal receiver pipes up:") : (0, import_kolmafia20.getProperty)("_horsery") === "crazy horse" && (0, import_kolmafia20.getProperty)("_horseryCrazyName") ? checkHookahSource(page, "crazy horse", (0, import_kolmafia20.getProperty)("_horseryCrazyName")) : null;
    // Start of battle
    case 1:
      return (0, import_kolmafia20.equippedAmount)(import_kolmafia20.Item.get("ittah bittah hookah")) > 0 ? checkHookahSource(page, "ittah bittha hookah", "takes a pull on the hookah") : null;
    default:
      return null;
  }
}
...
function spadeKiwi(encounter, page) {
  return (0, import_kolmafia21.currentRound)() !== 0 || (0, import_kolmafia21.myFamiliar)() !== import_kolmafia21.Familiar.get("Mini Kiwi") ? null : {
    player: Number((0, import_kolmafia21.myId)()),
    gotDrop: page.includes("You acquire an item: <b>mini kiwi</b>"),
    dropsToday: Number((0, import_kolmafia21.getProperty)("_miniKiwiDrops")),
    location: toNormalisedString((0, import_kolmafia21.myLocation)()),
    path: toNormalisedString((0, import_kolmafia21.myPath)()),
    baseWeight: (0, import_kolmafia21.familiarWeight)(import_kolmafia21.Familiar.get("Mini Kiwi")),
    buffedWeight: (0, import_kolmafia21.familiarWeight)(import_kolmafia21.Familiar.get("Mini Kiwi")) + (0, import_kolmafia21.weightAdjustment)(),
    turn: (0, import_kolmafia21.myTotalTurnsSpent)(),
    hasGoggles: (0, import_kolmafia21.haveEquipped)(import_kolmafia21.Item.get("aviator goggles")),
    monster: toNormalisedString((0, import_kolmafia21.lastMonster)())
  };
}
var MINI_KIWI = {
  name: "Mini Kiwi",
...
init_kolmafia_polyfill();
var import_es_string3 = __toESM(require_es_string_match_all(), 1), import_kolmafia22 = require("kolmafia");
function _typeof5(o) {
  "@babel/helpers - typeof";
...
}, MONSTER_DENYLIST = import_kolmafia22.Monster.get(["the darkness (blind)"]), MONSTER_SEARCH_DENYLIST = import_kolmafia22.Monster.get(["Perceiver of Sensations", "Performer of Actions", "Thinker of Thoughts"]), INDICATORS = [
  // { type: "familiar", prerequisite: Familiar.get("Bowlet"), pattern: "flaps directly into your opponent's (.+?), causing \\d+? damage" },
  {
    type: "effect",
    prerequisite: import_kolmafia22.Effect.get("Little Mouse Skull Buddy"),
    pattern: "The cute little floating mouse skull nibbles at your opponent's (.+?), dealing \\d+? damage"
  },
  {
    type: "equip",
    prerequisite: import_kolmafia22.Item.get("battery-powered drill"),
    pattern: "You drill a neat hole in your opponent's (.+?) which deals \\d+? damage"
  },
  {
    type: "equip",
    prerequisite: import_kolmafia22.Item.get("high-temperature mining drill"),
    pattern: "You drill a neat hole in your opponent's (.+?) which deals \\d+? damage"
  },
  {
    type: "familiar",
    prerequisite: import_kolmafia22.Familiar.get("Adorable Seal Larva"),
    pattern: "fangs your opponent in the (.+?) and greedily sucks the vital juices from the wound"
  },
  {
    type: "familiar",
    prerequisite: import_kolmafia22.Familiar.get("Adventurous Spelunker"),
    pattern: "whips your opponent in the (.+?), dealing \\d+? damage"
  },
  {
    type: "familiar",
    prerequisite: import_kolmafia22.Familiar.get("Left-Hand Man"),
    pattern: "smacks your opponent in the (.+?) with the"
  },
  {
    type: "item",
    prerequisite: import_kolmafia22.Item.get("electronics kit"),
    pattern: "You wire up a quick circuit and hook it to your opponent's (.+?)\\. You flip the switch"
  },
  {
    type: "item",
    prerequisite: import_kolmafia22.Item.get("small golem"),
...
function checkPrerequisite(_ref) {
  ...
  switch (type) {
    case "skill":
      return (0, import_kolmafia22.haveSkill)(prerequisite);
    case "effect":
      return (0, import_kolmafia22.haveEffect)(prerequisite) > 0;
    case "familiar":
      return (0, import_kolmafia22.myFamiliar)() === prerequisite;
    case "equip":
      return (0, import_kolmafia22.haveEquipped)(prerequisite);
    case "plant":
      return (_getFloristPlants$myL = (_getFloristPlants$myL2 = (0, import_kolmafia22.getFloristPlants)()[(0, import_kolmafia22.myLocation)().toString()]) === null || _getFloristPlants$myL2 === void 0 ? void 0 : _getFloristPlants$myL2.includes(prerequisite)) !== null && _getFloristPlants$myL !== void 0 ? _getFloristPlants$myL : !1;
    default:
      return !1;
  }
}
...
function checkElVibratoRestraints(data, page, monster, monsterParts) {
  if (!((0, import_kolmafia22.availableAmount)(import_kolmafia22.Item.get("El Vibrato restraints")) === 0 || !page.includes("lvcuff.gif"))) {
    var base = {
      monster: monster,
      part: "arm",
...
var MUTANT_COUTURE_SKILLS = {
  head: import_kolmafia22.Skill.get("Strangle"),
  arm: import_kolmafia22.Skill.get("Disarm"),
  leg: import_kolmafia22.Skill.get("Entangle")
};
function checkMutantCouture(data, page, monster, monsterParts) {
  (0, import_kolmafia22.currentRound)() !== 1 || !(0, import_kolmafia22.isWearingOutfit)("Mutant Couture") || !page.includes("<select name=whichskill>") || (data.push.apply(data, _toConsumableArray3(Object.entries(MUTANT_COUTURE_SKILLS).filter(function(_ref2) {
...
function checkEverfullDartHolster(data, page, monster, monsterParts) {
  if (!((0, import_kolmafia22.currentRound)() !== 1 || // eslint-disable-next-line libram/verify-constants
  !(0, import_kolmafia22.haveEquipped)(import_kolmafia22.Item.get("Everfull Dart Holster")))) {
    var buttAwareness = (0, import_kolmafia22.getProperty)("everfullDartPerks").includes("Butt awareness"), allDartParts = _toConsumableArray3(page.matchAll(DART_REGEX)).map(function(match) {
      return match[1];
...
function spadeMonsterParts(encounter, page) {
  if (MONSTER_DENYLIST.includes((0, import_kolmafia22.lastMonster)())) return null;
  var path = (0, import_kolmafia22.myPath)();
  if (path == import_kolmafia22.Path.get("Fall of the Dinosaurs") || path == import_kolmafia22.Path.get("Pocket Familiars")) return null;
  var monster = toNormalisedString((0, import_kolmafia22.lastMonster)()), monsterParts = (0, import_kolmafia22.lastMonster)().parts, data = [];
  return !isAdventureTextAltered() && !MONSTER_SEARCH_DENYLIST.includes((0, import_kolmafia22.lastMonster)()) && (checkSimpleIndicators(data, page, monster, monsterParts), checkElVibratoRestraints(data, page, monster, monsterParts)), checkMutantCouture(data, page, monster, monsterParts), checkEverfullDartHolster(data, page, monster, monsterParts), data;
}
...
function spadeMummingTrunk(encounter, page) {
  if ((0, import_kolmafia23.availableAmount)(import_kolmafia23.Item.get("mumming trunk")) === 0) return null;
  var fam = (0, import_kolmafia23.myFamiliar)();
  return (0, import_kolmafia23.getProperty)("_mummeryMods").includes(fam.toString()) ? (0, import_kolmafia23.getProperty)("_mummeryUses").split(",").filter(function(costume) {
...
var OUT_OF_ORDER = {
  ...
  hooks: {
    COMBAT_ROUND: function(encounter, page) {
      if ((0, import_kolmafia24.getProperty)("questEspOutOfOrder") === "unstarted" || !isEquippedAtEndOfCombat(import_kolmafia24.Item.get("GPS-tracking wristwatch")) || (0, import_kolmafia24.myLocation)() !== import_kolmafia24.Location.get("The Deep Dark Jungle")) return null;
      var beeps = page.match(/Your GPS tracker beeps ([0-9]+) times as it zeroes in on your quarry/);
      return beeps ? {
        beeps: beeps[1],
        initiative: (0, import_kolmafia24.numericModifier)(import_kolmafia24.Modifier.get("Initiative"))
      } : null;
    }
  }
};
...
function spadeSkeletonLetters(encounter, page) {
  if ((0, import_kolmafia25.currentRound)() !== 0 || !import_kolmafia25.Monster.get(["Axis artillery skeleton", "Axis grenadier skeleton", "Axis infantry skeleton", "Axis officer skeleton"]).includes((0, import_kolmafia25.lastMonster)())) return null;
  var regimentMatch = page.match(RegExp("".concat((0, import_kolmafia25.lastMonster)(), ", (\\d+)[a-z]+ regiment</span>")));
  if (regimentMatch) {
    var ribMatch = page.matchAll(/\/otherimages\/skeletonwar\/rib(\d)\.png/g), ribs = _toConsumableArray4(ribMatch).map(function(matchArray) {
      return matchArray[1];
    }).sort().join(","), regiment = Number(regimentMatch[1]), monster = (0, import_kolmafia25.lastMonster)().name;
    return {
      ribs: ribs,
      regiment: regiment,
      monster: monster
...
// ../excavator-projects/projects/subtypeGhost.ts
init_kolmafia_polyfill();
...
var SUBTYPE_GHOST = {
  ...
  hooks: {
    COMBAT_ROUND: function(encounter, page) {
      var path = (0, import_kolmafia26.myPath)();
      if (path == import_kolmafia26.Path.get("Pocket Familiars") || path == import_kolmafia26.Path.get("WereProfessor") || (0, import_kolmafia26.currentRound)() !== 1 || !page.includes("<select name=whichskill>"))
        return null;
      var monster = (0, import_kolmafia26.lastMonster)(), expected = monster.attributes.includes("GHOST");
      return pinchGhost(monster, expected) || protonicAccelerator(monster, expected);
    }
  },
  since: 28778
  // skeleton monster tracking
};
function pinchGhost(monster, expected) {
  if (!(0, import_kolmafia26.haveSkill)(import_kolmafia26.Skill.get("Pinch Ghost")))
    return null;
  var actual = (0, import_kolmafia26.combatSkillAvailable)(import_kolmafia26.Skill.get("Pinch Ghost"));
...
function protonicAccelerator(monster, expected) {
  if (!(0, import_kolmafia26.haveEquipped)(import_kolmafia26.Item.get("protonic accelerator pack")))
    return null;
  var actual = (0, import_kolmafia26.combatSkillAvailable)(import_kolmafia26.Skill.get("Shoot Ghost")) || (0, import_kolmafia26.combatSkillAvailable)(import_kolmafia26.Skill.get("Trap Ghost"));
  return actual !== expected ? {
    monster: toNormalisedString(monster),
    ghost: actual,
    reason: "ProtoPack"
...
// ../excavator-projects/projects/subtypeSkeleton.ts
init_kolmafia_polyfill();
var import_kolmafia27 = require("kolmafia");
var SUBTYPE_SKELETON = {
  ...
  hooks: {
    COMBAT_ROUND: function(encounter, page) {
      var path = (0, import_kolmafia27.myPath)();
      if (path == import_kolmafia27.Path.get("Pocket Familiars") || path == import_kolmafia27.Path.get("WereProfessor") || (0, import_kolmafia27.currentRound)() !== 1 || !page.includes("<select name=whichskill>") || !(0, import_kolmafia27.haveEquipped)(import_kolmafia27.Item.get("ring of telling skeletons what to do")))
        return null;
      var monster = (0, import_kolmafia27.lastMonster)(), expected = monster.attributes.includes("SKELETON"), actual = void 0;
      if ((0, import_kolmafia27.combatSkillAvailable)(import_kolmafia27.Skill.get("Tell This Skeleton What To Do")))
        actual = !0;
      else if ((0, import_kolmafia27.combatSkillAvailable)(import_kolmafia27.Skill.get("Tell a Skeleton What To Do")))
        actual = !1;
      else
        return null;
      return actual !== expected ? {
...
// ../excavator-projects/projects/subtypeZombie.ts
init_kolmafia_polyfill();
...
var SUBTYPE_ZOMBIE = {
  ...
  hooks: {
    COMBAT_ROUND: function(encounter, page) {
      if ((0, import_kolmafia28.currentRound)() !== 0)
        return null;
      if (page.includes("You grab a plump, wriggling worm from what's left of that zombie.")) {
        var monster = (0, import_kolmafia28.lastMonster)(), expected = monster.attributes.includes("ZOMBIE");
        if (!expected)
          return {
            monster: toNormalisedString(monster),
            zombie: !0
...
var ZONE_PATTERNS = /* @__PURE__ */ new Map([["Conspiracy Island", /The swarm of mayflies buzzes off into the spooky distance and returns a few minutes later, struggling under the weight of a mysterious coin/], ["Dinseylandfill", /The swarm of mayflies buzzes off into the distance and returns a few moments later carrying a rolled up FunFunds/], ["Twitch", /The swarm of mayflies buzzes off into the greasy distance and returns a few minutes later, struggling under the weight of a shiny coin/], ["Spring Break Beach", /The swarm of mayflies buzzes off into the greasy distance and returns a few minutes later, struggling under the weight of a damp bill/], ["The Glaciest", /The swarm of mayflies buzzes off into the frigid distance and returns a short while later carrying a rolled up Wal-Mart gift certificate/], ["Dreadsylvania", /The swarm of mayflies buzzes off into the dreary distance and returns a few minutes later, struggling under the weight of a coin/], ["Degrassi Knoll", /The swarm of mayflies buzzes off in the direction of one of the myriad workbenches littering the Knoll/]]), LOCATION_PATTERNS = /* @__PURE__ */ new Map([[import_kolmafia29.Location.get("Hobopolis Town Square"), /The swarm of mayflies buzzes off into the distance and returns a few minutes later, struggling under the weight of a coin/], [import_kolmafia29.Location.get("The Hole in the Sky"), /mistakes the swarm of flies for a different (and apparently very frightening) constellation, and runs off so fast it leaves some little bits of itself behind/], [import_kolmafia29.Location.get("The Sleazy Back Alley"), /The swarm flies into a dumpster, buzzes around for a bit, and flies back out looking slightly larger/], [import_kolmafia29.Location.get("The Slime Tube"), /The swarm of mayflies plunges into the mass of Slime and emerges a few moments later, coated with goo and carrying a little glob of something/], [import_kolmafia29.Location.get("South of The Border"), /After the fight is over, one of those annoying kids runs up and tries to sell you some gum/]]), SWARM_PATTERN = /mayflies(\d+)\.gif/, ITEM_PATTERN = /The swarm of mayflies buzzes around the ground, helping you find stuff/, MEAT_PATTERN = /The swarm of mayflies draws your attention to more Meat than you would've otherwise found/, SUMMON_MAYFLY_SWARM = {
  ...
  hooks: {
    COMBAT_ROUND: function(_, page) {
      ...
      if (!isEquippedAtEndOfCombat(import_kolmafia29.Item.get("mayfly bait necklace"))) return null;
      var specialPattern = (_ZONE_PATTERNS$get = ZONE_PATTERNS.get((0, import_kolmafia29.myLocation)().zone)) !== null && _ZONE_PATTERNS$get !== void 0 ? _ZONE_PATTERNS$get : LOCATION_PATTERNS.get((0, import_kolmafia29.myLocation)());
      if (!specialPattern) return null;
      var swarmResult = page.match(SWARM_PATTERN);
      if (!swarmResult) return null;
      var swarmSize = Number(swarmResult[1]), area = ZONE_PATTERNS.has((0, import_kolmafia29.myLocation)().zone) ? (0, import_kolmafia29.myLocation)().zone : "".concat((0, import_kolmafia29.myLocation)()), patterns = {
...
function spadeRiftlet(encounter, page) {
  var riftlet = import_kolmafia30.Familiar.get("Temporal Riftlet");
  return (0, import_kolmafia30.currentRound)() !== 0 || (0, import_kolmafia30.myFamiliar)() !== riftlet ? null : {
    weight: (0, import_kolmafia30.familiarWeight)(riftlet) + (0, import_kolmafia30.weightAdjustment)() + riftlet.soupWeight + (riftlet.feasted ? 10 : 0),
...
// ../excavator-projects/index.ts
var projects = [AUTUMNATON, BIRD_A_DAY, BLACK_AND_WHITE_APRON, COAT_OF_PAINT, GENIE, HOOKAH, JUICE_BAR, DROP_BINDLESTOCKING, DROP_CON_SNOWGLOBE, DROP_CUP_OF_13, DROP_MIXED_EVERYTHING, DROP_MR_CHEENGS, DROP_MR_SCREEGES, DROP_ORDNANCE_MAGNET, DROP_PORTABLE_LAUGHING_STOCK, DROP_PULLED_RED_TAFFY, MINI_KIWI, MONSTER_PARTS, MUMMING_TRUNK, OUT_OF_ORDER, REQUEST_SUPPLY_DROP_GREY, REQUEST_SUPPLY_DROP_LETTER, DESIGNER_SWEATPANTS, SUMMON_MAYFLY_SWARM, SKELETON_LETTERS, SKELETON_OF_CRIMBO_PAST, SUBTYPE_GHOST, SUBTYPE_SKELETON, SUBTYPE_ZOMBIE, TEMPORAL_RIFTLET, ZOOTOMIST_KICK, COOKBOOKBAT, BLUE_TEAM_MONSTERS, RED_TEAM_MONSTERS];
...
var createPropertyGetter = function(transform) {
  return function(property, default_) {
    var value = (0, import_kolmafia32.getProperty)(property);
...
var getString = createPropertyGetter(function(value) {
  ...
  return Number(value);
}), getBounty = createMafiaClassPropertyGetter(import_kolmafia32.Bounty, import_kolmafia32.toBounty), getClass = createMafiaClassPropertyGetter(import_kolmafia32.Class, import_kolmafia32.toClass), getCoinmaster = createMafiaClassPropertyGetter(import_kolmafia32.Coinmaster, import_kolmafia32.toCoinmaster), getEffect = createMafiaClassPropertyGetter(import_kolmafia32.Effect, import_kolmafia32.toEffect), getElement = createMafiaClassPropertyGetter(import_kolmafia32.Element, import_kolmafia32.toElement), getFamiliar = createMafiaClassPropertyGetter(import_kolmafia32.Familiar, import_kolmafia32.toFamiliar, familiarNumericProperties), getItem = createMafiaClassPropertyGetter(import_kolmafia32.Item, import_kolmafia32.toItem, itemNumericProperties), getLocation = createMafiaClassPropertyGetter(import_kolmafia32.Location, import_kolmafia32.toLocation), getMonster = createMafiaClassPropertyGetter(import_kolmafia32.Monster, import_kolmafia32.toMonster, monsterNumericProperties), getPhylum = createMafiaClassPropertyGetter(import_kolmafia32.Phylum, import_kolmafia32.toPhylum), getServant = createMafiaClassPropertyGetter(import_kolmafia32.Servant, import_kolmafia32.toServant), getSkill = createMafiaClassPropertyGetter(import_kolmafia32.Skill, import_kolmafia32.toSkill), getSlot = createMafiaClassPropertyGetter(import_kolmafia32.Slot, import_kolmafia32.toSlot), getStat = createMafiaClassPropertyGetter(import_kolmafia32.Stat, import_kolmafia32.toStat), getThrall = createMafiaClassPropertyGetter(import_kolmafia32.Thrall, import_kolmafia32.toThrall);
function get(property, _default) {
  ...
  return _default instanceof import_kolmafia32.Location ? getLocation(property, _default) : _default instanceof import_kolmafia32.Monster ? getMonster(property, _default) : _default instanceof import_kolmafia32.Familiar ? getFamiliar(property, _default) : _default instanceof import_kolmafia32.Stat ? getStat(property, _default) : _default instanceof import_kolmafia32.Phylum ? getPhylum(property, _default) : _default instanceof import_kolmafia32.Item ? getItem(property, _default) : typeof _default == "boolean" ? value === "true" ? !0 : value === "false" ? !1 : _default : typeof _default == "number" ? value === "" ? _default : parseInt(value) : value === "" ? _default === void 0 ? "" : _default : value;
}
function _set(property, value) {
  var stringValue = value === null ? "" : value.toString();
  return (0, import_kolmafia32.setProperty)(property, stringValue), value;
}
  ...
  return _createClass(PropertiesManager2, [{
    ...
    value: function(propertiesToSet) {
      for (var _i2 = 0, _Object$entries2 = Object.entries(propertiesToSet); _i2 < _Object$entries2.length; _i2++) {
        ...
        propertyName in this.properties || (this.properties[propertyName] = (0, import_kolmafia32.propertyExists)(propertyName) ? get(propertyName) : PropertiesManager2.EMPTY_PREFERENCE), _set(propertyName, propertyValue);
      }
    }
    /**
    ...
    value: function() {
      ...
      for (var _i3 = 0, _properties = properties; _i3 < _properties.length; _i3++) {
        ...
        if (property in this.properties) {
          ...
          value === PropertiesManager2.EMPTY_PREFERENCE ? (0, import_kolmafia32.removeProperty)(property) : _set(property, value);
        }
      }
    }
    /**
...
var concatTemplateString = function(literals) {
  ...
  match ? (0, import_kolmafia33.print)("".concat(match[0], "; if you're certain that this ").concat(Type.name, " exists and is spelled correctly, please update KoLMafia"), "red") : (0, import_kolmafia33.print)(message);
...
}, $bounty = createSingleConstant(import_kolmafia33.Bounty, import_kolmafia33.toBounty), $bounties = createPluralConstant(import_kolmafia33.Bounty), $class = createSingleConstant(import_kolmafia33.Class, import_kolmafia33.toClass), $classes = createPluralConstant(import_kolmafia33.Class), $coinmaster = createSingleConstant(import_kolmafia33.Coinmaster, import_kolmafia33.toCoinmaster), $coinmasters = createPluralConstant(import_kolmafia33.Coinmaster), $effect = createSingleConstant(import_kolmafia33.Effect, import_kolmafia33.toEffect), $effects = createPluralConstant(import_kolmafia33.Effect), $element = createSingleConstant(import_kolmafia33.Element, import_kolmafia33.toElement), $elements = createPluralConstant(import_kolmafia33.Element), $familiar = createSingleConstant(import_kolmafia33.Familiar, import_kolmafia33.toFamiliar), $familiars = createPluralConstant(import_kolmafia33.Familiar), $item = createSingleConstant(import_kolmafia33.Item, import_kolmafia33.toItem), $items = createPluralConstant(import_kolmafia33.Item), $location = createSingleConstant(import_kolmafia33.Location, import_kolmafia33.toLocation), $locations = createPluralConstant(import_kolmafia33.Location), $modifier = createSingleConstant(import_kolmafia33.Modifier, import_kolmafia33.toModifier), $modifiers = createPluralConstant(import_kolmafia33.Modifier), $monster = createSingleConstant(import_kolmafia33.Monster, import_kolmafia33.toMonster), $monsters = createPluralConstant(import_kolmafia33.Monster), $path = createSingleConstant(import_kolmafia33.Path, import_kolmafia33.toPath), $paths = createPluralConstant(import_kolmafia33.Path), $phylum = createSingleConstant(import_kolmafia33.Phylum, import_kolmafia33.toPhylum), $phyla = createPluralConstant(import_kolmafia33.Phylum), $servant = createSingleConstant(import_kolmafia33.Servant, import_kolmafia33.toServant), $servants = createPluralConstant(import_kolmafia33.Servant), $skill = createSingleConstant(import_kolmafia33.Skill, import_kolmafia33.toSkill), $skills = createPluralConstant(import_kolmafia33.Skill), $slot = createSingleConstant(import_kolmafia33.Slot, import_kolmafia33.toSlot), $slots = createPluralConstant(import_kolmafia33.Slot), $stat = createSingleConstant(import_kolmafia33.Stat, import_kolmafia33.toStat), $stats = createPluralConstant(import_kolmafia33.Stat), $thrall = createSingleConstant(import_kolmafia33.Thrall, import_kolmafia33.toThrall), $thralls = createPluralConstant(import_kolmafia33.Thrall);
...
var byStat = makeByXFunction(function() {
  return (0, import_kolmafia34.myPrimestat)().toString();
}), byClass = makeByXFunction(function() {
  return (0, import_kolmafia34.myClass)().toString();
});
function extractItems(text) {
  return new Map(Object.entries((0, import_kolmafia34.extractItems)(text)).map(function(_ref13) {
    var _ref14 = _slicedToArray8(_ref13, 2), itemName = _ref14[0], quantity = _ref14[1];
    return [import_kolmafia34.Item.get(itemName), quantity];
  }));
}
function makeScalerCalcFunction(cache, pattern) {
  return function(monster) {
    var _find, _pattern$exec$slice, _pattern$exec, current = cache.get(monster);
    if (current !== void 0) return (0, import_kolmafia34.monsterEval)(current);
    ...
    return cache.set(monster, result), (0, import_kolmafia34.monsterEval)(result);
  };
}
...
var makeBulkFunction = function(action) {
  return function(items) {
    ...
    return (0, import_kolmafia34.batchClose)();
  };
}, bulkAutosell = makeBulkFunction(import_kolmafia34.autosell), bulkPutCloset = makeBulkFunction(import_kolmafia34.putCloset), bulkPutDisplay = makeBulkFunction(import_kolmafia34.putDisplay), bulkPutStash = makeBulkFunction(import_kolmafia34.putStash), bulkTakeCloset = makeBulkFunction(import_kolmafia34.takeCloset), bulkTakeDisplay = makeBulkFunction(import_kolmafia34.takeDisplay), bulkTakeShop = makeBulkFunction(import_kolmafia34.takeShop), bulkTakeStash = makeBulkFunction(import_kolmafia34.takeStash), bulkTakeStorage = makeBulkFunction(import_kolmafia34.takeStorage);
...
init_kolmafia_polyfill();
var import_html_entities = __toESM(require_lib(), 1), import_kolmafia36 = require("kolmafia");
...
function fetchUrl(path) {
  ...
  return (0, import_kolmafia35.visitUrl)(url, method === "POST", !0);
}
...
var Kmail = /* @__PURE__ */ function() {
  ...
  return _createClass2(Kmail2, [{
    ...
    value: function() {
      ...
      return !outsideAttachments && !insideAttachments ? 0 : (0, import_kolmafia36.extractMeat)("".concat(outsideAttachments).concat(insideAttachments));
    }
    /**
     * Reply to kmail
     *
    ...
    value: function() {
      ...
      return JSON.parse((0, import_kolmafia36.visitUrl)("api.php?what=kmail&for=libram&count=".concat(count))).map(Kmail2.parse);
    }
    /**
     * Bulk delete kmails
     *
    ...
    value: function(to, message, items, meat, chunkSize, constructUrl, successString) {
      var m = meat, sendableItems = _toConsumableArray7(arrayToCountedMap(items).entries()).filter(function(_ref3) {
        ...
        return (0, import_kolmafia36.isGiftable)(item);
...
function getExcavatorVersion() {
  return (0, import_kolmafia37.gitInfo)("loathers-excavator-release").commit.substring(0, 7) || (0, import_kolmafia37.gitInfo)("gausie-excavator-release").commit.substring(0, 7) || 0;
}
function getVersionString() {
  return "".concat((0, import_kolmafia37.getRevision)(), "/").concat(getExcavatorVersion());
}
function canKmail() {
  return (
    // In a fight
    !((0, import_kolmafia37.currentRound)() > 0 || // In a choice
    (0, import_kolmafia37.handlingChoice)() || // Was in a choice, gonna be in a fight
    (0, import_kolmafia37.fightFollowsChoice)() || // Was in a fight, gonna be in a choice
    (0, import_kolmafia37.choiceFollowsFight)() || // Was in a fight, gonna be in another fight
    (0, import_kolmafia37.inMultiFight)())
  );
}
...
function flushSpadingData() {
  for (var spadingData = get(DATA_PROPERTY).split("|"), i = 0; i < spadingData.length - 2; ) {
    ...
    if (!success) {
      (0, import_kolmafia37.print)("Sending a kmail failed while Excavator was flushing the spading cache. Flush aborted.", "red");
      return;
    }
    i++;
  }
...
function sendSpadingData(projectName, data) {
  ...
  if (canKmail()) {
    ...
    (0, import_kolmafia37.printHtml)('<font color="green">Sending spading data for <b>'.concat(projectName, "</b>").concat(flushMessage, " to ").concat(recipient, ". Thanks!</font>"));
    var success = Kmail.send(recipient, dataString);
    if (success) {
      flushSpadingData(), deleteSpadingKmail(recipient);
      return;
    }
    (0, import_kolmafia37.print)("Excavator thought it could send data via kmail but it can't. Saving to cache instead.", "orange");
  }
  addSpadingData(dataString, recipient, "Excavator's project to spade ".concat(projectName));
}
function deleteSpadingKmail(sentTo) {
  var buffer = (0, import_kolmafia37.visitUrl)("messages.php?box=Outbox&begin=1&order=0&per_page=10").toLowerCase(), messageIds = buffer.split("td valign=top").filter(function(s) {
  ...
  if (messageIds.length > 0) {
    ...
    (0, import_kolmafia37.visitUrl)(del);
  }
}
...
function main(event, meta, page) {
  projects.filter(function(_ref) {
    ...
    return !completed && event in hooks && since <= (0, import_kolmafia38.getRevision)() && ((0, import_kolmafia38.myPath)() !== import_kolmafia38.Path.get("Two Crazy Random Summer") || allowInTcrs);
  }).map(function(_ref2) {

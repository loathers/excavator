...
init_kolmafia_polyfill();
var import_es_string = __toESM(require_es_string_match_all()), import_kolmafia8 = require("kolmafia");
...
init_kolmafia_polyfill();
var import_kolmafia12 = require("kolmafia"), GENIE = {
  name: "Genie",
...
function spadeGenie(page) {
  ...
  if (fightWished) {
    var monster = (0, import_kolmafia12.toMonster)(fightWished[1]);
    if (monster === import_kolmafia12.Monster.none) return null;
    ...
    var effect = (0, import_kolmafia12.toEffect)(effectWished[1]);
    if (effect === import_kolmafia12.Effect.none) return null;
...
init_kolmafia_polyfill();
var import_kolmafia13 = require("kolmafia"), HOOKAH = {
  name: "Hookah",
...
function extractEffectFromEvent(page, eventTriggerText) {
  var _page$match;
  if (!page.includes(eventTriggerText)) return import_kolmafia13.Effect.none;
  ...
  return descid ? (0, import_kolmafia13.descToEffect)(descid) : import_kolmafia13.Effect.none;
}
...
function checkHookahSource(page, source, eventTriggerText) {
  ...
  return effect === import_kolmafia13.Effect.none || isHookahable(effect) ? null : {
    source: source,
    effect: effect.toString()
  };
}
function spadeHookah(encounter, page) {
  switch ((0, import_kolmafia13.currentRound)()) {
    // End of battle
    case 0:
      return (0, import_kolmafia13.equippedAmount)(import_kolmafia13.Item.get("enhanced signal receiver")) > 0 ? checkHookahSource(page, "enhanced signal receiver", "Your signal receiver pipes up:") : (0, import_kolmafia13.getProperty)("_horsery") === "crazy horse" && (0, import_kolmafia13.getProperty)("_horseryCrazyName") ? checkHookahSource(page, "crazy horse", (0, import_kolmafia13.getProperty)("_horseryCrazyName")) : null;
    // Start of battle
    case 1:
      return (0, import_kolmafia13.equippedAmount)(import_kolmafia13.Item.get("ittah bittah hookah")) > 0 ? checkHookahSource(page, "ittah bittha hookah", "takes a pull on the hookah") : null;
    default:
      return null;
  }
}
...
function spadeKiwi(encounter, page) {
  return (0, import_kolmafia14.currentRound)() !== 0 || (0, import_kolmafia14.myFamiliar)() !== import_kolmafia14.Familiar.get("Mini Kiwi") ? null : {
    player: Number((0, import_kolmafia14.myId)()),
    gotDrop: page.includes("You acquire an item: <b>mini kiwi</b>"),
    dropsToday: Number((0, import_kolmafia14.getProperty)("_miniKiwiDrops")),
    location: toNormalisedString((0, import_kolmafia14.myLocation)()),
    path: toNormalisedString((0, import_kolmafia14.myPath)()),
    baseWeight: (0, import_kolmafia14.familiarWeight)(import_kolmafia14.Familiar.get("Mini Kiwi")),
    buffedWeight: (0, import_kolmafia14.familiarWeight)(import_kolmafia14.Familiar.get("Mini Kiwi")) + (0, import_kolmafia14.weightAdjustment)(),
    turn: (0, import_kolmafia14.myTotalTurnsSpent)(),
    hasGoggles: (0, import_kolmafia14.haveEquipped)(import_kolmafia14.Item.get("aviator goggles")),
    monster: toNormalisedString((0, import_kolmafia14.lastMonster)())
  };
}
var MINI_KIWI = {
  name: "Mini Kiwi",
...
init_kolmafia_polyfill();
var import_es_string3 = __toESM(require_es_string_match_all()), import_kolmafia15 = require("kolmafia");
function _typeof5(o) {
  "@babel/helpers - typeof";
...
}, MONSTER_DENYLIST = import_kolmafia15.Monster.get(["the darkness (blind)"]), MONSTER_SEARCH_DENYLIST = import_kolmafia15.Monster.get(["Perceiver of Sensations", "Performer of Actions", "Thinker of Thoughts"]), INDICATORS = [
  // { type: "familiar", prerequisite: Familiar.get("Bowlet"), pattern: "flaps directly into your opponent's (.+?), causing \\d+? damage" },
  {
    type: "effect",
    prerequisite: import_kolmafia15.Effect.get("Little Mouse Skull Buddy"),
    pattern: "The cute little floating mouse skull nibbles at your opponent's (.+?), dealing \\d+? damage"
  },
  {
    type: "equip",
    prerequisite: import_kolmafia15.Item.get("battery-powered drill"),
    pattern: "You drill a neat hole in your opponent's (.+?) which deals \\d+? damage"
  },
  {
    type: "equip",
    prerequisite: import_kolmafia15.Item.get("high-temperature mining drill"),
    pattern: "You drill a neat hole in your opponent's (.+?) which deals \\d+? damage"
  },
  {
    type: "familiar",
    prerequisite: import_kolmafia15.Familiar.get("Adorable Seal Larva"),
    pattern: "fangs your opponent in the (.+?) and greedily sucks the vital juices from the wound"
  },
  {
    type: "familiar",
    prerequisite: import_kolmafia15.Familiar.get("Adventurous Spelunker"),
    pattern: "whips your opponent in the (.+?), dealing \\d+? damage"
  },
  {
    type: "familiar",
    prerequisite: import_kolmafia15.Familiar.get("Left-Hand Man"),
    pattern: "smacks your opponent in the (.+?) with the"
  },
  {
    type: "item",
    prerequisite: import_kolmafia15.Item.get("electronics kit"),
    pattern: "You wire up a quick circuit and hook it to your opponent's (.+?)\\. You flip the switch"
  },
  {
    type: "item",
    prerequisite: import_kolmafia15.Item.get("small golem"),
...
function checkPrerequisite(_ref) {
  ...
  switch (type) {
    case "skill":
      return (0, import_kolmafia15.haveSkill)(prerequisite);
    case "effect":
      return (0, import_kolmafia15.haveEffect)(prerequisite) > 0;
    case "familiar":
      return (0, import_kolmafia15.myFamiliar)() === prerequisite;
    case "equip":
      return (0, import_kolmafia15.haveEquipped)(prerequisite);
    case "plant":
      return (_getFloristPlants$myL = (_getFloristPlants$myL2 = (0, import_kolmafia15.getFloristPlants)()[(0, import_kolmafia15.myLocation)().toString()]) === null || _getFloristPlants$myL2 === void 0 ? void 0 : _getFloristPlants$myL2.includes(prerequisite)) !== null && _getFloristPlants$myL !== void 0 ? _getFloristPlants$myL : !1;
    default:
      return !1;
  }
}
...
function checkElVibratoRestraints(data, page, monster, monsterParts) {
  if (!((0, import_kolmafia15.availableAmount)(import_kolmafia15.Item.get("El Vibrato restraints")) === 0 || !page.includes("lvcuff.gif"))) {
    var base = {
      monster: monster,
      part: "arm",
...
var MUTANT_COUTURE_SKILLS = {
  head: import_kolmafia15.Skill.get("Strangle"),
  arm: import_kolmafia15.Skill.get("Disarm"),
  leg: import_kolmafia15.Skill.get("Entangle")
};
function checkMutantCouture(data, page, monster, monsterParts) {
  (0, import_kolmafia15.currentRound)() !== 1 || !(0, import_kolmafia15.isWearingOutfit)("Mutant Couture") || !page.includes("<select name=whichskill>") || (data.push.apply(data, _toConsumableArray3(Object.entries(MUTANT_COUTURE_SKILLS).filter(function(_ref2) {
...
function checkEverfullDartHolster(data, page, monster, monsterParts) {
  if (!((0, import_kolmafia15.currentRound)() !== 1 || // eslint-disable-next-line libram/verify-constants
  !(0, import_kolmafia15.haveEquipped)(import_kolmafia15.Item.get("Everfull Dart Holster")))) {
    var buttAwareness = (0, import_kolmafia15.getProperty)("everfullDartPerks").includes("Butt awareness"), allDartParts = _toConsumableArray3(page.matchAll(DART_REGEX)).map(function(match) {
      return match[1];
...
function spadeMummingTrunk(encounter, page) {
  if ((0, import_kolmafia16.availableAmount)(import_kolmafia16.Item.get("mumming trunk")) === 0) return null;
  var fam = (0, import_kolmafia16.myFamiliar)();
  return (0, import_kolmafia16.getProperty)("_mummeryMods").includes(fam.toString()) ? (0, import_kolmafia16.getProperty)("_mummeryUses").split(",").filter(function(costume) {
...
var OUT_OF_ORDER = {
  ...
  hooks: {
    COMBAT_ROUND: function(encounter, page) {
      if ((0, import_kolmafia17.getProperty)("questEspOutOfOrder") === "unstarted" || !isEquippedAtEndOfCombat(import_kolmafia17.Item.get("GPS-tracking wristwatch")) || (0, import_kolmafia17.myLocation)() !== import_kolmafia17.Location.get("The Deep Dark Jungle")) return null;
      var beeps = page.match(/Your GPS tracker beeps ([0-9]+) times as it zeroes in on your quarry/);
      return beeps ? {
        beeps: beeps[1],
        initiative: (0, import_kolmafia17.numericModifier)(import_kolmafia17.Modifier.get("Initiative"))
      } : null;
    }
  }
};
...
var ZONE_PATTERNS = /* @__PURE__ */ new Map([["Conspiracy Island", /The swarm of mayflies buzzes off into the spooky distance and returns a few minutes later, struggling under the weight of a mysterious coin/], ["Dinseylandfill", /The swarm of mayflies buzzes off into the distance and returns a few moments later carrying a rolled up FunFunds/], ["Twitch", /The swarm of mayflies buzzes off into the greasy distance and returns a few minutes later, struggling under the weight of a shiny coin/], ["Spring Break Beach", /The swarm of mayflies buzzes off into the greasy distance and returns a few minutes later, struggling under the weight of a damp bill/], ["The Glaciest", /The swarm of mayflies buzzes off into the frigid distance and returns a short while later carrying a rolled up Wal-Mart gift certificate/], ["Dreadsylvania", /The swarm of mayflies buzzes off into the dreary distance and returns a few minutes later, struggling under the weight of a coin/], ["Degrassi Knoll", /The swarm of mayflies buzzes off in the direction of one of the myriad workbenches littering the Knoll/]]), LOCATION_PATTERNS = /* @__PURE__ */ new Map([[import_kolmafia18.Location.get("Hobopolis Town Square"), /The swarm of mayflies buzzes off into the distance and returns a few minutes later, struggling under the weight of a coin/], [import_kolmafia18.Location.get("The Hole in the Sky"), /mistakes the swarm of flies for a different (and apparently very frightening) constellation, and runs off so fast it leaves some little bits of itself behind/], [import_kolmafia18.Location.get("The Sleazy Back Alley"), /The swarm flies into a dumpster, buzzes around for a bit, and flies back out looking slightly larger/], [import_kolmafia18.Location.get("The Slime Tube"), /The swarm of mayflies plunges into the mass of Slime and emerges a few moments later, coated with goo and carrying a little glob of something/], [import_kolmafia18.Location.get("South of The Border"), /After the fight is over, one of those annoying kids runs up and tries to sell you some gum/]]), SWARM_PATTERN = /mayflies(\d+)\.gif/, ITEM_PATTERN = /The swarm of mayflies buzzes around the ground, helping you find stuff/, MEAT_PATTERN = /The swarm of mayflies draws your attention to more Meat than you would've otherwise found/, SUMMON_MAYFLY_SWARM = {
  ...
  hooks: {
    COMBAT_ROUND: function(_, page) {
      ...
      if (!isEquippedAtEndOfCombat(import_kolmafia18.Item.get("mayfly bait necklace"))) return null;
      var specialPattern = (_ZONE_PATTERNS$get = ZONE_PATTERNS.get((0, import_kolmafia18.myLocation)().zone)) !== null && _ZONE_PATTERNS$get !== void 0 ? _ZONE_PATTERNS$get : LOCATION_PATTERNS.get((0, import_kolmafia18.myLocation)());
      if (!specialPattern) return null;
      var swarmResult = page.match(SWARM_PATTERN);
      if (!swarmResult) return null;
      var swarmSize = Number(swarmResult[1]), area = ZONE_PATTERNS.has((0, import_kolmafia18.myLocation)().zone) ? (0, import_kolmafia18.myLocation)().zone : "".concat((0, import_kolmafia18.myLocation)()), patterns = {
...
function spadeRiftlet(encounter, page) {
  var riftlet = import_kolmafia19.Familiar.get("Temporal Riftlet");
  return (0, import_kolmafia19.currentRound)() !== 0 || (0, import_kolmafia19.myFamiliar)() !== riftlet ? null : {
    weight: (0, import_kolmafia19.familiarWeight)(riftlet) + (0, import_kolmafia19.weightAdjustment)() + riftlet.soupWeight + (riftlet.feasted ? 10 : 0),
...
// ../excavator-projects/index.ts
var projects = [AUTUMNATON, BIRD_A_DAY, BLACK_AND_WHITE_APRON, COAT_OF_PAINT, GENIE, HOOKAH, JUICE_BAR, DROP_BINDLESTOCKING, DROP_CON_SNOWGLOBE, DROP_MIXED_EVERYTHING, DROP_MR_CHEENGS, DROP_MR_SCREEGES, MINI_KIWI, MONSTER_PARTS, MUMMING_TRUNK, OUT_OF_ORDER, DESIGNER_SWEATPANTS, SUMMON_MAYFLY_SWARM, TEMPORAL_RIFTLET];
...
var createPropertyGetter = function(transform) {
  return function(property, default_) {
    var value = (0, import_kolmafia20.getProperty)(property);
...
var getString = createPropertyGetter(function(value) {
  ...
  return Number(value);
}), getBounty = createMafiaClassPropertyGetter(import_kolmafia20.Bounty, import_kolmafia20.toBounty), getClass = createMafiaClassPropertyGetter(import_kolmafia20.Class, import_kolmafia20.toClass), getCoinmaster = createMafiaClassPropertyGetter(import_kolmafia20.Coinmaster, import_kolmafia20.toCoinmaster), getEffect = createMafiaClassPropertyGetter(import_kolmafia20.Effect, import_kolmafia20.toEffect), getElement = createMafiaClassPropertyGetter(import_kolmafia20.Element, import_kolmafia20.toElement), getFamiliar = createMafiaClassPropertyGetter(import_kolmafia20.Familiar, import_kolmafia20.toFamiliar, familiarNumericProperties), getItem = createMafiaClassPropertyGetter(import_kolmafia20.Item, import_kolmafia20.toItem, itemNumericProperties), getLocation = createMafiaClassPropertyGetter(import_kolmafia20.Location, import_kolmafia20.toLocation), getMonster = createMafiaClassPropertyGetter(import_kolmafia20.Monster, import_kolmafia20.toMonster, monsterNumericProperties), getPhylum = createMafiaClassPropertyGetter(import_kolmafia20.Phylum, import_kolmafia20.toPhylum), getServant = createMafiaClassPropertyGetter(import_kolmafia20.Servant, import_kolmafia20.toServant), getSkill = createMafiaClassPropertyGetter(import_kolmafia20.Skill, import_kolmafia20.toSkill), getSlot = createMafiaClassPropertyGetter(import_kolmafia20.Slot, import_kolmafia20.toSlot), getStat = createMafiaClassPropertyGetter(import_kolmafia20.Stat, import_kolmafia20.toStat), getThrall = createMafiaClassPropertyGetter(import_kolmafia20.Thrall, import_kolmafia20.toThrall);
function get(property, _default) {
  ...
  return _default instanceof import_kolmafia20.Location ? getLocation(property, _default) : _default instanceof import_kolmafia20.Monster ? getMonster(property, _default) : _default instanceof import_kolmafia20.Familiar ? getFamiliar(property, _default) : _default instanceof import_kolmafia20.Stat ? getStat(property, _default) : _default instanceof import_kolmafia20.Phylum ? getPhylum(property, _default) : _default instanceof import_kolmafia20.Item ? getItem(property, _default) : typeof _default == "boolean" ? value === "true" ? !0 : value === "false" ? !1 : _default : typeof _default == "number" ? value === "" ? _default : parseInt(value) : value === "" ? _default === void 0 ? "" : _default : value;
}
function _set(property, value) {
  var stringValue = value === null ? "" : value.toString();
  return (0, import_kolmafia20.setProperty)(property, stringValue), value;
}
  ...
  return _createClass(PropertiesManager2, [{
    ...
    value: function(propertiesToSet) {
      for (var _i2 = 0, _Object$entries2 = Object.entries(propertiesToSet); _i2 < _Object$entries2.length; _i2++) {
        ...
        propertyName in this.properties || (this.properties[propertyName] = (0, import_kolmafia20.propertyExists)(propertyName) ? get(propertyName) : PropertiesManager2.EMPTY_PREFERENCE), _set(propertyName, propertyValue);
      }
    }
    /**
    ...
    value: function() {
      ...
      for (var _i3 = 0, _properties = properties; _i3 < _properties.length; _i3++) {
        ...
        if (property in this.properties) {
          ...
          value === PropertiesManager2.EMPTY_PREFERENCE ? (0, import_kolmafia20.removeProperty)(property) : _set(property, value);
        }
      }
    }
    /**
    ...
    key: "resetAll",
    value: function() {
      this.reset.apply(this, _toConsumableArray4(Object.keys(this.properties)));
    }
    /**
...
var concatTemplateString = function(literals) {
  ...
  match ? (0, import_kolmafia21.print)("".concat(match[0], "; if you're certain that this ").concat(Type.name, " exists and is spelled correctly, please update KoLMafia"), "red") : (0, import_kolmafia21.print)(message);
...
}, $bounty = createSingleConstant(import_kolmafia21.Bounty, import_kolmafia21.toBounty), $bounties = createPluralConstant(import_kolmafia21.Bounty), $class = createSingleConstant(import_kolmafia21.Class, import_kolmafia21.toClass), $classes = createPluralConstant(import_kolmafia21.Class), $coinmaster = createSingleConstant(import_kolmafia21.Coinmaster, import_kolmafia21.toCoinmaster), $coinmasters = createPluralConstant(import_kolmafia21.Coinmaster), $effect = createSingleConstant(import_kolmafia21.Effect, import_kolmafia21.toEffect), $effects = createPluralConstant(import_kolmafia21.Effect), $element = createSingleConstant(import_kolmafia21.Element, import_kolmafia21.toElement), $elements = createPluralConstant(import_kolmafia21.Element), $familiar = createSingleConstant(import_kolmafia21.Familiar, import_kolmafia21.toFamiliar), $familiars = createPluralConstant(import_kolmafia21.Familiar), $item = createSingleConstant(import_kolmafia21.Item, import_kolmafia21.toItem), $items = createPluralConstant(import_kolmafia21.Item), $location = createSingleConstant(import_kolmafia21.Location, import_kolmafia21.toLocation), $locations = createPluralConstant(import_kolmafia21.Location), $modifier = createSingleConstant(import_kolmafia21.Modifier, import_kolmafia21.toModifier), $modifiers = createPluralConstant(import_kolmafia21.Modifier), $monster = createSingleConstant(import_kolmafia21.Monster, import_kolmafia21.toMonster), $monsters = createPluralConstant(import_kolmafia21.Monster), $path = createSingleConstant(import_kolmafia21.Path, import_kolmafia21.toPath), $paths = createPluralConstant(import_kolmafia21.Path), $phylum = createSingleConstant(import_kolmafia21.Phylum, import_kolmafia21.toPhylum), $phyla = createPluralConstant(import_kolmafia21.Phylum), $servant = createSingleConstant(import_kolmafia21.Servant, import_kolmafia21.toServant), $servants = createPluralConstant(import_kolmafia21.Servant), $skill = createSingleConstant(import_kolmafia21.Skill, import_kolmafia21.toSkill), $skills = createPluralConstant(import_kolmafia21.Skill), $slot = createSingleConstant(import_kolmafia21.Slot, import_kolmafia21.toSlot), $slots = createPluralConstant(import_kolmafia21.Slot), $stat = createSingleConstant(import_kolmafia21.Stat, import_kolmafia21.toStat), $stats = createPluralConstant(import_kolmafia21.Stat), $thrall = createSingleConstant(import_kolmafia21.Thrall, import_kolmafia21.toThrall), $thralls = createPluralConstant(import_kolmafia21.Thrall);
...
var byStat = makeByXFunction(function() {
  return (0, import_kolmafia22.myPrimestat)().toString();
}), byClass = makeByXFunction(function() {
  return (0, import_kolmafia22.myClass)().toString();
});
function extractItems(text) {
  return new Map(Object.entries((0, import_kolmafia22.extractItems)(text)).map(function(_ref15) {
    var _ref16 = _slicedToArray8(_ref15, 2), itemName = _ref16[0], quantity = _ref16[1];
    return [import_kolmafia22.Item.get(itemName), quantity];
  }));
}
function makeScalerCalcFunction(cache, pattern) {
  return function(monster) {
    var _pattern$exec$, _pattern$exec, current = cache.get(monster);
    if (current !== void 0) return (0, import_kolmafia22.monsterEval)(current);
    ...
    return cache.set(monster, result), (0, import_kolmafia22.monsterEval)(result);
  };
}
...
var makeBulkFunction = function(action) {
  return function(items) {
    ...
    return (0, import_kolmafia22.batchClose)();
  };
}, bulkAutosell = makeBulkFunction(import_kolmafia22.autosell), bulkPutCloset = makeBulkFunction(import_kolmafia22.putCloset), bulkPutDisplay = makeBulkFunction(import_kolmafia22.putDisplay), bulkPutStash = makeBulkFunction(import_kolmafia22.putStash), bulkTakeCloset = makeBulkFunction(import_kolmafia22.takeCloset), bulkTakeDisplay = makeBulkFunction(import_kolmafia22.takeDisplay), bulkTakeShop = makeBulkFunction(import_kolmafia22.takeShop), bulkTakeStash = makeBulkFunction(import_kolmafia22.takeStash), bulkTakeStorage = makeBulkFunction(import_kolmafia22.takeStorage);
...
init_kolmafia_polyfill();
var import_html_entities = __toESM(require_lib(), 1), import_kolmafia24 = require("kolmafia");
...
function fetchUrl(path) {
  ...
  return (0, import_kolmafia23.visitUrl)(url, method === "POST", !0);
}
...
function combineQuery() {
  ...
  for (var result = [], _i = 0, _queries = queries; _i < _queries.length; _i++) {
    ...
    Array.isArray(query) ? result.push.apply(result, _toConsumableArray5(query)) : result.push.apply(result, _toConsumableArray5(Object.entries(query)));
  }
  return result;
}
...
var Kmail = /* @__PURE__ */ function() {
  ...
  return _createClass2(Kmail2, [{
    ...
    value: function() {
      ...
      return !outsideAttachments && !insideAttachments ? 0 : (0, import_kolmafia24.extractMeat)("".concat(outsideAttachments).concat(insideAttachments));
    }
    /**
     * Reply to kmail
     *
    ...
    value: function() {
      ...
      return JSON.parse((0, import_kolmafia24.visitUrl)("api.php?what=kmail&for=libram&count=".concat(count))).map(Kmail2.parse);
    }
    /**
     * Bulk delete kmails
     *
    ...
    value: function(kmails) {
      var _results$match$, _results$match, results = fetchUrl("messages.php", [["the_action", "delete"], ["box", "Inbox"], ["pwd", EMPTY_VALUE]].concat(_toConsumableArray6(kmails.map(function(k) {
    ...
    value: function(to, message, items, meat, chunkSize, constructUrl, successString) {
      var m = meat, sendableItems = _toConsumableArray6(arrayToCountedMap(items).entries()).filter(function(_ref3) {
        var _ref4 = _slicedToArray10(_ref3, 1), item = _ref4[0];
        return (0, import_kolmafia24.isGiftable)(item);
...
function getExcavatorVersion() {
  return (0, import_kolmafia25.gitInfo)("loathers-excavator-release").commit.substring(0, 7) || (0, import_kolmafia25.gitInfo)("gausie-excavator-release").commit.substring(0, 7) || 0;
}
function getVersionString() {
  return "".concat((0, import_kolmafia25.getRevision)(), "/").concat(getExcavatorVersion());
}
function canKmail() {
  return (
    // In a fight
    !((0, import_kolmafia25.currentRound)() > 0 || // In a choice
    (0, import_kolmafia25.handlingChoice)() || // Was in a choice, gonna be in a fight
    (0, import_kolmafia25.fightFollowsChoice)() || // Was in a fight, gonna be in a choice
    (0, import_kolmafia25.choiceFollowsFight)() || // Was in a fight, gonna be in another fight
    (0, import_kolmafia25.inMultiFight)())
  );
}
...
function flushSpadingData() {
  for (var spadingData = get(DATA_PROPERTY).split("|"), i = 0; i < spadingData.length - 2; ) {
    ...
    if (!success) {
      (0, import_kolmafia25.print)("Sending a kmail failed while Excavator was flushing the spading cache. Flush aborted.", "red");
      return;
    }
    i++;
  }
...
function sendSpadingData(projectName, data) {
  ...
  if (canKmail()) {
    ...
    (0, import_kolmafia25.printHtml)('<font color="green">Sending spading data for <b>'.concat(projectName, "</b>").concat(flushMessage, " to ").concat(recipient, ". Thanks!</font>"));
    var success = Kmail.send(recipient, dataString);
    if (success) {
      flushSpadingData(), deleteSpadingKmail(recipient);
      return;
    }
    (0, import_kolmafia25.print)("Excavator thought it could send data via kmail but it can't. Saving to cache instead.", "orange");
  }
  addSpadingData(dataString, recipient, "Excavator's project to spade ".concat(projectName));
}
function deleteSpadingKmail(sentTo) {
  var buffer = (0, import_kolmafia25.visitUrl)("messages.php?box=Outbox&begin=1&order=0&per_page=10").toLowerCase(), messageIds = buffer.split("td valign=top").filter(function(s) {
  ...
  if (messageIds.length > 0) {
    ...
    (0, import_kolmafia25.visitUrl)(del);
  }
}

// src/excavator.ts
function _slicedToArray11(r, e) {
  return _arrayWithHoles11(r) || _iterableToArrayLimit11(r, e) || _unsupportedIterableToArray14(r, e) || _nonIterableRest11();
}
...
function main(event, meta, page) {
  projects.filter(function(_ref) {
    ...
    return !completed && event in hooks && since <= (0, import_kolmafia26.getRevision)();
  }).map(function(_ref2) {
